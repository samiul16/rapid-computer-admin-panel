...
// Initial Data :: For Add new Row :: For Add Mode
  ...
  return (
    <>
      <div className="relative">
        <Button
          variant="filled"
          className="my-4 h-[50px] rounded-full! bg-sky-500! hover:bg-sky-400!"
        ...
        <div className="overflow-auto border rounded-lg h-[250px] grid-scroll">
          {/* Sticky header */}
          <div
            className="grid sticky top-0 z-20 h-[50px] bg-gray-100 dark:bg-gray-900 gap-[1px] w-full"
            style={{
...
export default memo(DynamicInputTableList);
