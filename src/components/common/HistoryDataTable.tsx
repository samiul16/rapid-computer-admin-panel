...
export default function HistoryDataTable({
  ...
  return (
    <div className="h-[67vh] flex flex-col">
        ...
        <div className="flex justify-center">
          <div className="relative max-w-md w-full">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-full focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm"
              value={globalFilter}
              ...
              {table.getHeaderGroups().map((headerGroup) => (
                <tr key={headerGroup.id}>
                  {headerGroup.headers.map((header) => (
                    <th
                      key={header.id}
                      className="pl-3 py-2 text-left text-xs font-medium text-gray-500 capitalize tracking-wider border-b border-gray-200 bg-gray-50"
                      style={{
      ...
      {/* Fixed Footer */}
      <div className="flex-shrink-0 border-t px-4 py-2 mb-2">
        <div className="flex items-center justify-between text-sm text-gray-600">
          <span>Total 35 countries</span>
