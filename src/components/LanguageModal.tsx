...
const LanguageModal = () => {
  ...
  const languagesData: { code: string; name: string; flag: string }[] = [
    ...
    { code: "bn", name: "Bengali", flag: "https://flagcdn.com/bd.svg" },
  ];
    ...
    <div className="bg-white rounded-xl shadow-lg w-full p-6">
      ...
      <div className="space-y-2 relative">
        <Autocomplete
          ...
          flagCode={languagesData.map((item) => item.flag)}
      ...
      <div className="mt-6 text-right">
        <Button className="px-4 py-2 text-white rounded">Apply</Button>
      </div>
    </div>
  );
};
...
const Autocomplete = ({
  ...
  React.InputHTMLAttributes<HTMLInputElement> & {
    ...
    dataList: { code: string; name: string; flag: string }[];
  }) => {
        ...
        <div className="relative">
          ...
          >
            <input
              ...
              disabled={disabled}
              className={cn(
                "flex h-10 w-full border! border-input bg-white! px-3 py-2 pr-10 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
          ...
          {/* get flag from flagCode */}
          <img
            className="w-4 h-4 absolute left-4 top-[29px] transform -translate-y-1/2"
            src={filteredDataList[0]?.flag}
            alt={labelText}
          />
        </div>
              ...
              <ul ref={listRef} className="py-1">
                {filteredOptions.map((option: any, index: any) => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex-1 flex items-center gap-2 text-[#00000099]">
                        <img
                          height={20}
                          width={20}
                          src={flagCode[index]}
