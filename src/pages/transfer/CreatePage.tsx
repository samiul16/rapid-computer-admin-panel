...
export default function TransferFormPage({ isEdit = false }: Props) {
  ...
  const canEdit = usePermission("transfer", "edit");
  const canDelete = usePermission("transfer", "delete");
  ...
  const date: boolean = usePermission("transfer", "create", "date");
  const iqamaNo: boolean = usePermission("transfer", "create", "iqamaNo");
  const branch: boolean = usePermission("transfer", "create", "branch");
  const fromField: boolean = usePermission("transfer", "create", "from");
  const toField: boolean = usePermission("transfer", "create", "to");
  const descriptionField: boolean = usePermission(
    "transfer",
    "create",
    "description"
  );
  const isDraft: boolean = usePermission("transfer", "create", "isDraft");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (keepCreating) {
      toastSuccess("Transfer created successfully!");
      handleReset();
    } else {
      toastSuccess("Transfer created successfully!");
      navigate("/transfer");
