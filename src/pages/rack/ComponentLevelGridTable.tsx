...
export const gridCardData: GridCardDataType[] = [
  {
    ...
    name: "Rack A1",
    code: "RK-A1",
    description: "Dry item storage in Shelf A1",
    status: "active",
    isDeleted: false,
  },
  {
    ...
    name: "Rack A2",
    code: "RK-A2",
    description: "Backup rack beside Rack A1",
    status: "active",
    isDeleted: false,
  },
  {
    ...
    name: "Rack B1",
    code: "RK-B1",
    description: "Cold storage compatible rack",
    status: "inactive",
    isDeleted: false,
  },
  {
    ...
    name: "Rack B2",
    code: "RK-B2",
    description: "Bakery section rack",
    status: "active",
    isDeleted: false,
  },
  {
    ...
    name: "Rack C1",
    code: "RK-C1",
    description: "Spices and flavorings storage",
    status: "draft",
    isDeleted: false,
  },
  {
    ...
    name: "Rack C2",
    code: "RK-C2",
    description: "Frozen goods storage rack",
    status: "active",
    isDeleted: false,
  },
  {
    ...
    name: "Rack D1",
    code: "RK-D1",
    description: "General-purpose inventory rack",
    status: "active",
    isDeleted: false,
  },
  {
    ...
    name: "Rack D2",
    code: "RK-D2",
    description: "Staff supply storage rack",
    status: "inactive",
    isDeleted: false,
  },
];
...
export default function ComponentLevelGridTable({
  ...
  const loadMoreData = useCallback(async () => {
    ...
    const newItems = Array.from({ length: ITEMS_PER_PAGE }, (_, index) => ({
      ...
      name: `Rack Name#${gridData.length + index + 1}`,
  ...
  return (
    <div className="px-4 py-3 h-full flex flex-col bg-white dark:bg-gray-900 parent">
          ...
          {isLoading && (
            <div className="flex justify-center items-center py-8">
              <div className="flex items-center gap-2 text-blue-600">
                ...
                <span className="text-sm">Loading more rack...</span>
              </div>
            </div>
          )}
      ...
      <Modal
        ...
        title={
          <div className="">
            <h3 className="text-lg font-semibold pl-4">Import Rack</h3>
          </div>
        }
        size="xl"
        overlayProps={{
