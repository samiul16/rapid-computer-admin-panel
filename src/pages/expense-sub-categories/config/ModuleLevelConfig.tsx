...
export const searchableKeys: (keyof ModuleFieldsType)[] = ["name"];
...
export const tableViewColumnSchema: TableViewDataTableColumnConfig[] = [
  { key: "name", title: "Name" },
  { key: "selectExpenseCategory", title: "Select Expense Category" },
...
export const MOCK_TABLE_DATA: TableViewDataType[] = [
  {
    id: "1",
    name: "Dashboard",
    selectExpenseCategory: "Dashboard",
  ...
  },
  {
    id: "3",
    name: "Analytics",
    selectExpenseCategory: "Analytics",
    description: "lorem ipsume",
    status: "Updated",
  ...
  },
  {
    id: "5",
    name: "Invoices",
    selectExpenseCategory: "lorem ipsume",
    description: "lorem ipsume",
    status: "Active",
...
export const formFields: FieldConfig[] = [
  {
    ...
    label: "Name",
    component: "input",
    nextFocus: "selectExpenseCategory",
    tooltip: "Enter name",
    required: true,
  },
  {
    ...
    options: ["Expense Category 1", "Expense Category 2", "Expense Category 3"],
    placeholder: " ",
    nextFocus: "description",
    tooltip: "Enter selectExpenseCategory",
    required: true,
  },
  {
    name: "description",
