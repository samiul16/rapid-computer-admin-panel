...
export default function InsurancesCreatePage({ isEdit = false }: Props) {
  ...
  const name: boolean = usePermission("insurances", "create", "name");

  const isDefault: boolean = usePermission("insurances", "create", "isDefault");
  const isDraft: boolean = usePermission("insurances", "create", "isDraft");
  ...
  const handlePrintIncrements = (InsurancesData: any) => {
    try {
