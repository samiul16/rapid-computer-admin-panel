...
export default function ShiftEditPage({ isEdit = false }: Props) {
  ...
  const permissionsFields = usePermission<keyof MockData>("shifts", "edit", [
    "shift",
    "startTime",
    "endTime",
    "isDefault",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toastSuccess("Shifts  Edited successfully");
  };
  ...
  const handlePrintShifts = (MockData: any) => {
    try {
