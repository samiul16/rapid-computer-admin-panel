...
export default function IncrementsDetailsPage() {
  ...
  const canSeeHistory: boolean = usePermission("increments", "history");
  ...
  let incrementsData = {
    name: "3 Month Increment",
    date: "05/01/2023",
    amount: 1500,
    note: "Regular Increment",
  ...
  const handlePrintCountry = (incrementsData: any) => {
    try {
  ...
  const handleSwitchChange = (checked: boolean) => {
    ...
    // if (checked) {
    //   setTimeout(() => handlePrintCountry(incrementsData), 100);
    // }
  };
  ...
  const handleExportPDF = async () => {
    ...
    try {
      console.log("incrementsData on pdf click", incrementsData);
  ...
  return (
    <>
      <PageLayout
        title={t("button.viewingIncrements")}
        videoSrc={video}
        ...
        popoverOptions={[
          {
            ...
            onClick: () => navigate("/increments/create"),
          },
          {
            label: "Edit",
        ...
        onExport={
          canPdf && canPrint
            ? () => {
                ...
                if (printEnabled) {
                  handlePrintCountry(incrementsData);
                }
              }
            : undefined
        }
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
          <div className="mt-1">
            <Autocomplete
              ...
              value={incrementsData.employeeName}
          ...
          <div className="">
            ...
            <div className="w-full py-1 text-gray-900 font-bold text-md dark:text-white">
              {displayValue(incrementsData.iqamaNo)}
            </div>
          </div>
          ...
          <div className="">
            ...
            <div className="w-full py-1 text-gray-900 font-bold text-md dark:text-white">
              {displayValue(incrementsData.name)}
            </div>
          </div>
          ...
          <div className="">
            ...
            <div className="w-full py-1 text-gray-900 font-bold text-md dark:text-white">
              {displayValue(incrementsData.date)}
            </div>
          </div>
          <div className="">
            <div className="flex justify-between items-center mb-1">
              <h3 className="font-normal text-gray-600">Amount</h3>
            </div>
            <div className="w-full py-1 text-gray-900 font-bold text-md dark:text-white">
              {displayValue(incrementsData.amount)}
            </div>
          </div>
          <div className="">
            <h3 className="font-normal mb-1 text-gray-600">Note</h3>
            <div className="w-full py-1 text-gray-900 font-bold text-md dark:text-white">
              {displayValue(incrementsData.note)}
            </div>
          </div>
      ...
      <HistoryDataTable
        ...
        title="History"
        statusInfo={{
          created: getRelativeTime(incrementsData.createdAt),
          updated: getRelativeTime(incrementsData.updatedAt),
          drafted: getRelativeTime(incrementsData.draftedAt),
          deleted: getRelativeTime(incrementsData.deletedAt),
        }}
      />
