...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "tenants.csv");
  const handleExcel = () => exportToExcel(mockData, "tenants.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          subtitle="Tenants Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "tenants-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
