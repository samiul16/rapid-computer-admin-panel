...
export const plansData: GridDataType[] = [
  {
    ...
    expenseFor: "John Doe",
    applyToVat: "Yes",
    note: "Business trip to New York",
  ...
  },
  {
    ...
    purchaseNumber: "67890",
    supplierVatNumber: "987654321",
    expenseBy: "Jane Smith",
    expenseFor: "Jane Smith",
    applyToVat: "Yes",
    note: "3-night stay in London",
    attachment: "Hotel_Invoice.pdf",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  {
    id: "3",
    branch: "Branch Office - Dhaka",
    voucherNumber: "V003",
    category: "Office Supplies",
    subCategory: "Stationery",
    expense: "Notebooks & Pens",
    date: "2025-08-25",
    amount: "1500",
    currency: "BDT",
    paymentMode: "Cash",
    vat: "5%",
    supplier: "Dhaka Stationery House",
    approvedBy: "Mizanur Rahman",
    purchaseNumber: "24567",
    supplierVatNumber: "452365987",
    expenseBy: "Mizanur Rahman",
    expenseFor: "Admin Team",
    applyToVat: "Yes",
    note: "Stationery for staff",
  ...
  {
    id: "4",
    branch: "Branch Office - Chittagong",
    voucherNumber: "V004",
    category: "Utilities",
    ...
    purchaseNumber: "36521",
    supplierVatNumber: "N/A",
    expenseBy: "Kamrul Hasan",
    expenseFor: "Office Electricity",
    applyToVat: "No",
    note: "Monthly electricity bill",
    attachment: "BPDB_Bill.pdf",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    approvedBy: "John Doe",
    purchaseNumber: "48659",
    supplierVatNumber: "369852147",
    expenseBy: "Marketing Team",
    expenseFor: "Campaign A",
    applyToVat: "Yes",
    note: "August Facebook campaign",
    attachment: "Meta_Ads.pdf",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    paymentMode: "Cash",
    vat: "0%",
    supplier: "Bangladesh Railway",
    approvedBy: "Shakil Ahmed",
    purchaseNumber: "96587",
    supplierVatNumber: "N/A",
    expenseBy: "Shakil Ahmed",
    expenseFor: "Sales Team",
    applyToVat: "No",
    note: "Business trip to Rajshahi",
    attachment: "Railway_Ticket.pdf",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    purchaseNumber: "78524",
    supplierVatNumber: "MS987654321",
    expenseBy: "IT Department",
    expenseFor: "Company-wide",
    applyToVat: "Yes",
    note: "Annual subscription renewal",
    attachment: "MS365_Invoice.pdf",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  {
    id: "8",
    branch: "Branch Office - Sylhet",
    voucherNumber: "V008",
    category: "Maintenance",
    subCategory: "Office Equipment",
    expense: "AC Servicing",
    date: "2025-09-07",
    amount: "3500",
    currency: "BDT",
    paymentMode: "Cash",
    vat: "5%",
    supplier: "Sylhet Cooling Services",
    approvedBy: "Branch Manager",
    purchaseNumber: "15973",
    supplierVatNumber: "753159842",
    expenseBy: "Maintenance Team",
    expenseFor: "Office Cooling",
    applyToVat: "Yes",
    note: "Quarterly AC servicing",
  ...
  },
  {
    ...
    purchaseNumber: "95173",
    supplierVatNumber: "LI246813579",
    expenseBy: "HR Department",
    expenseFor: "Mid-level Managers",
    applyToVat: "Yes",
    note: "3-day leadership program",
    attachment: "Training_Bill.pdf",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  {
    id: "10",
    branch: "Branch Office - Rajshahi",
    voucherNumber: "V010",
    category: "Transport",
    subCategory: "Fuel",
    expense: "Diesel for Office Car",
    date: "2025-09-12",
    amount: "7000",
    currency: "BDT",
    paymentMode: "Cash",
    vat: "0%",
    supplier: "PetroBangla",
    approvedBy: "Branch Head",
    purchaseNumber: "65482",
    supplierVatNumber: "N/A",
    expenseBy: "Driver",
    expenseFor: "Office Vehicle",
    applyToVat: "No",
    note: "September fuel expense",
    attachment: "Fuel_Receipt.pdf",
    isDefault: true,
    isActive: true,
    isDraft: false,
