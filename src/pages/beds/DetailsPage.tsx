...
const projectTypeOptions = ["Bed 1", "Bed 2", "Bed 3"];
...
export default function BedsDetails() {
  ...
  const fieldPermissions = usePermission<keyof TermsData>("beds", "view", [
    "bedName",
    "description",
    "isDefault",
    "isActive",
        ...
        popoverOptions={[
          {
            ...
            onClick: () => navigate("/beds/create"),
          },
          {
            label: "Edit",
            icon: <Edit className="w-5 h-5 text-blue-600" />,
            onClick: () => navigate("/beds/edit/1"),
          },
        ]}
