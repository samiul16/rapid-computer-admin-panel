...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "beds.csv");
  const handleExcel = () => exportToExcel(mockData, "beds.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          title="Beds Details"
          subtitle="Beds Information Report"
        />
      ).toBlob();
