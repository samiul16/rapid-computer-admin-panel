...
export default function ContactTypeFormPage({ isEdit = false }: Props) {
  ...
  const canDelete = usePermission("contactType", "delete");
  ...
  const namePerm: boolean = usePermission("contactType", "create", "name");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (keepCreating) {
      toastSuccess("Contact Type created successfully!");
      handleReset();
    } else {
      toastSuccess("Contact Type created successfully!");
      navigate("/contact-type");
