...
import AssetMaintenancesGrid from "./Grid";
import AssetMaintenancesDataTable from "./DataTable";
  ...
  return (
    <div className="w-100vw px-2 py-4 dark:bg-gray-900">
      ...
      <PageHeader
        ...
        createPath="/asset-maintenances/create"
      />
