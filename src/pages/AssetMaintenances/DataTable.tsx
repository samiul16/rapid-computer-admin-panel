...
const MockData = [
  ...
  },
  {
    ...
    title: "SSD Installation & RAM Upgrade",
  ...
  },
  {
    ...
    maintenanceType: "Repair",
    title: "Paper Jam Fix & Roller Cleaning",
  ...
  },
  {
    ...
    maintenanceType: "Inspection",
    title: "Screen Calibration & Software Update",
...
export default function AssetMaintenancesDataTable({
  viewMode,
  setViewMode,
  dataTableFilter,
  searchQuery,
  ...
  const componentColumns = [
    {
      accessorKey: "asset",
      title: "Asset",
      options: [...new Set(MockData.map((item) => item.asset))],
      ...
      sortingFn: (row1: any, row2: any) => {
        return row1.getValue("asset").localeCompare(row2.getValue("asset"));
      },
      size: 180,
      minSize: 150,
      meta: {
    ...
    },
    {
      ...
      options: [...new Set(MockData.map((item) => item.maintenanceType))],
      filterFn: (row: any, columnId: any, filterValue: any) => {
        if (!filterValue || filterValue.length === 0) return true;
        const cellValue = row.getValue(columnId) as string;
        return filterValue.some((filterVal: string) =>
  ...
  return (
    <FixedColumnDataTable
      ...
      fixedColumns={["asset", "status"]} // Pin country name column
      pathName="asset-maintenances"
