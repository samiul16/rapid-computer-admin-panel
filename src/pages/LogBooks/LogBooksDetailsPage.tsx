...
export default function LogBooksDetailsPage() {
  ...
  const canDelete: boolean = usePermission("logBooks", "delete");
  const canCreate: boolean = usePermission("logBooks", "create");
  const canView: boolean = usePermission("logBooks", "view");
  const canPrint: boolean = usePermission("logBooks", "print");
  const canSeeHistory: boolean = usePermission("logBooks", "history");
  ...
  return (
    <>
      <PageLayout
        title={t("button.viewingLogBooks")}
        videoSrc={video}
        videoHeader="Tutorial video"
        onListClick={() => navigate("/log-books")}
        listText="List"
        listPath="log-books"
        activePage="view"
        popoverOptions={[
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
          <div className="">
            <h3 className="font-normal mb-1 text-gray-600">Booking</h3>
            <div className="w-full py-1 text-gray-900 font-bold text-md dark:text-white">
              {displayValue(LogData.booking)}
            </div>
          </div>
          ...
          <div className="">
            <h3 className="font-normal mb-1 text-gray-600">Driver</h3>
            <div className="w-full py-1 text-gray-900 font-bold text-md dark:text-white">
              {displayValue(LogData.driver)}
            </div>
          </div>

          <div className="">
            <h3 className="font-normal mb-1 text-gray-600">Log Books</h3>
            <div className="w-full py-1 text-gray-900 font-bold text-md dark:text-white">
              {displayValue(LogData.logBooks)}
            </div>
          </div>

          <div className="">
            <h3 className="font-normal mb-1 text-gray-600">Odometers</h3>
            <div className="w-full py-1 text-gray-900 font-bold text-md dark:text-white">
              {displayValue(LogData.odoMeters)}
            </div>
          </div>
          ...
          <div className="">
            ...
            <div className="w-full py-1 text-gray-900 font-bold text-md dark:text-white">
              {displayValue(LogData.description)}
            </div>
          </div>
