...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "vehicles.csv");
  const handleExcel = () => exportToExcel(mockData, "vehicles.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          subtitle="Vehicle Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "vehicle-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
