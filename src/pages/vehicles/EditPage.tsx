...
export default function VehiclesEditPage({ isEdit = false }: Props) {
  ...
  const isActive: boolean = usePermission("vehicles", "create", "isActive");
  const isDeleted: boolean = usePermission("vehicles", "create", "isDeleted");
