...
export const plansData: GridDataType[] = [
  ...
  },
  {
    ...
    slNo: "6",
    unitTitle: "Gram",
    description: "Small unit of mass measurement",
    status: "Active",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    slNo: "8",
    unitTitle: "Dozen",
    description: "Unit for counting 12 items",
    status: "Active",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    slNo: "12",
    unitTitle: "Set",
    description: "Unit for grouped items",
    status: "Active",
    isDefault: true,
    isActive: true,
    isDraft: false,
        ...
        >
          <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 pb-4 p-2">
            {filteredData.map((item, index) => (
              ...
              >
                {/* Top Row - Grid with 2 columns: Unit Title | Status */}
