...
export default function LoyaltyProgramsGrid({
  searchQuery,
  setIsFilterOpen,
  isFilterOpen,
  setIsExportOpen,
  ...
  const canRestore: boolean = usePermission("loyaltyPrograms", "restore");
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Total {gridData.length} Loyalty Programs
        </span>
      </div>
              ...
              >
                ...
                <div className="grid grid-cols-2 items-center gap-2 mb-4">
                  ...
                  <CardTitle
                    ...
                    onClick={() => navigate(`/loyalty-programs/1`)}
                  >
                    {item.customer}
                  </CardTitle>
