...
import SampleReceivingGrid from "./SampleReceivingGrid";
import SampleReceivingDataTable from "./SampleReceivingDataTable";
  ...
  return (
    <div className="w-100vw px-2 py-4 dark:bg-gray-900">
      ...
      <PageHeader
        ...
        createPath="/sample-receiving/create"
      />
