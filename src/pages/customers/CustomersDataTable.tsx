...
const customers: Customer[] = [
  ...
  },
  {
    id: "2",
    customerNo: "CUST002",
    customerName: "Dhaka Electronics",
    shortName: "DE",
    inActive: false,
    vatNumber: "VATBD1245",
    vendorCode: "VEND002",
  ...
  },
  {
    id: "6",
    customerNo: "CUST006",
    customerName: "Barcelona Beverages",
    shortName: "BBEV",
    inActive: false,
    paymentMode: "Cash",
    currency: "EUR",
  ...
  },
  {
    id: "7",
    customerNo: "CUST007",
    customerName: "Karachi Wholesalers",
    shortName: "KWS",
    inActive: false,
  ...
  const componentColumns = [
    {
      ...
      title: "Customer Name",
      options: [...new Set(customers.map((item) => item.customerName))],
