...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "customers.csv");
  const handleExcel = () => exportToExcel(mockData, "customers.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          subtitle="Customers Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "customers-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
