...
export const plansData: GridDataType[] = [
  ...
  {
    id: "11",
    projectGroup: "SupportTech Corp",
    vatNumber: "VAT741852963",
    website: "www.supporttech.corp",
    phone: "+1-555-0741",
    currency: "USD",
    country: "United States",
    language: "English",
    street: "852 Support Street, Phoenix, AZ 85001",
    isDefault: false,
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-01-01"),
  ...
  {
    id: "12",
    projectGroup: "Enterprise Client",
    vatNumber: "VAT963741852",
    website: "www.enterpriseclient.com",
    phone: "+1-555-0963",
    currency: "USD",
    country: "United States",
    language: "English",
    street: "963 Enterprise Boulevard, San Francisco, CA 94101",
    isDefault: true,
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-01-01"),
        ...
        >
          <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 pb-4 p-2">
            {filteredData.map((item, index) => (
              ...
              >
                {/* Top Row - Grid with 2 columns: Project Group | Status */}
                ...
                {/* Middle Row - VAT Number and Website */}
                ...
                {/* Bottom Row - Grid with 3 columns: Currency | Actions | Country */}
