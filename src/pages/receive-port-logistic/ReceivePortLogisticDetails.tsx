...
export default function PurchaseOrderLogisticDetailsPage() {
  ...
  // get permission
  const canCreate: boolean = usePermission("receivePortLogistic", "create");
  const canView: boolean = usePermission("receivePortLogistic", "view");
  ...
  const canExport: boolean = usePermission("receivePortLogistic", "export");
  ...
  const getPurchaseOrderLogisticData = (
    optionName: string
  ): ReceivePortLogisticData => {
    const dataMap: Record<string, ReceivePortLogisticData> = {
      "001 - Al-Rashid Trading Company": {
        country: "Saudi Arabia",
        company: "Al-Rashid Trading Company",
  ...
  return (
    <>
      <PageLayout
        title="Viewing Receive Port Logistic"
        videoSrc={video}
        videoHeader="Tutorial video"
        onListClick={() => navigate("/receive-port-logistic")}
        listText="List"
        ...
        popoverOptions={[
          {
            ...
            onClick: () => navigate("/receive-port-logistic/create"),
          },
          {
            label: "Edit",
            icon: <Edit className="w-5 h-5 text-blue-600" />,
            onClick: () => navigate("/receive-port-logistic/edit/1"),
          },
        ]}
