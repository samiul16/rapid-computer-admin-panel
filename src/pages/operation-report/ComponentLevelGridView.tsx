...
// Updated mock data for appointments
export const appointmentsData: GridDataType[] = [
  {
    id: "1",
    patientId: "P001",
    date: "2025-09-15",
  ...
  },
  {
    ...
    description: "Heart condition follow-up and ECG review",
  ...
  },
  {
    ...
    description: "Child development assessment and vaccinations",
  ...
  },
  {
    ...
    description: "Routine dental hygiene and oral health check",
    doctorName: "Dr. Andrew Wilson",
    status: "Confirmed",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    description: "Rehabilitation session for lower back pain",
  ...
  },
  {
    ...
    description: "Mental health evaluation and therapy session",
...
export default function ComponentLevelGridView({
  ...
  const [gridData, setGridData] = useState(appointmentsData);
  ...
  const loadMoreData = useCallback(async () => {
    ...
    const newItems = Array.from({ length: ITEMS_PER_PAGE }, (_, index) => ({
      ...appointmentsData[index % appointmentsData.length],
      id: `${Date.now()}-${index}`,
      patientId: `P${String(Math.floor(Math.random() * 1000)).padStart(
        3,
        "0"
      )}`,
      isDefault: false,
            ...
            {filteredData.map((item, index) => (
              ...
              >
                ...
                <div className="flex items-start justify-between gap-2 mb-4">
                  <CardTitle
                    className="text-lg font-semibold cursor-pointer hover:text-primary transition-colors truncate flex-1"
