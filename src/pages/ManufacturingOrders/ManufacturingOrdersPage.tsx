...
import ManufacturingOrdersGrid from "./Grid";
import ManufacturingOrdersDataTable from "./DataTable";
  ...
  return (
    <div className="w-100vw px-2 py-4 dark:bg-gray-900">
      ...
      <PageHeader
        ...
        createPath="/manufacturing-orders/create"
      />
