...
export default function ManufacturingOrdersGrid({
  searchQuery,
  setIsFilterOpen,
  isFilterOpen,
  setIsExportOpen,
  ...
  const canRestore: boolean = usePermission("manufacturingOrders", "restore");
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Total {filteredData.length} Manufacturing Orders
        </span>
      </div>
              ...
              >
                ...
                <div className="grid grid-cols-2 items-center gap-2 mb-4">
                  ...
                  <CardTitle
                    ...
                    onClick={() => navigate(`/manufacturing-orders/1`)}
                  >
                    {Items.customer}
                  </CardTitle>
                    ...
                    {canEdit && (
                      ...
                      >
                        <div
                          ...
                          onClick={() => navigate(`/manufacturing-orders/edit/1`)}
                        >
          ...
          {isLoading && (
            <div className="flex justify-center items-center py-8">
              <div className="flex items-center gap-2 text-blue-600">
                ...
                <span className="text-sm">Loading more Item...</span>
              </div>
            </div>
          )}
