...
const autocompleteDataDetailsPage = ["Option One", "Option Two"];
...
export default function PatientAdmissionDetails() {
  ...
  const getLeavesData = (leaveType: string): DetailsPageTypes => {
    const leavesMap: Record<string, DetailsPageTypes> = {
      "Option One": initialData,
      "Option Two": initialData,
    };
            ...
            {fieldPermissions.admissionId && (
              <div className="mt-1">
                <Autocomplete
                  ...
                  placeholder=" "
                  displayKey="admissionId"
                  valueKey="admissionId"
