...
import StateGrid from "@/pages/user-master/UserMasterGrid";
import { useTranslation } from "react-i18next";
import { useNavigate } from "react-router-dom";
import StateDataTable from "./UserMasterDataTable";
  ...
  return (
    <div className="w-100vw px-2 py-4 dark:bg-gray-900">
      ...
      <div className="flex items-center gap-4 mb-4">
        ...
        <h1 className="text-2xl font-bold flex-1 text-primary">User Master</h1>
        <Button
