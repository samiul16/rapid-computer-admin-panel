...
import LeavesApplicationGrid from "./LeavesApplicationGrid";
import LeavesApplicationDataTable from "./LeavesApplicationDataTable";
  ...
  return (
    <div className="w-100vw px-2 py-4 dark:bg-gray-900">
      ...
      <PageHeader
        ...
        createPath="/leaves-application/create"
      />
