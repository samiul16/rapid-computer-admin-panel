...
export default function CertificatesCreatePage({ isEdit = false }: Props) {
  ...
  const name: boolean = usePermission("certificates", "create", "name");
  ...
  const handlePrintIncrements = (CertificatesData: any) => {
    try {
