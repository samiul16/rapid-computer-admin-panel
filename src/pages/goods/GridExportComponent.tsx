...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "goods.csv");
  const handleExcel = () => exportToExcel(mockData, "goods.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          title="Goods Details"
          subtitle="Goods Information Report"
        />
      ).toBlob();
