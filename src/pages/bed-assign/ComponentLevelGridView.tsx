...
export const moduleData: GridDataType[] = [
  {
    id: "1",
    patientId: "P001",
    roomName: "Room A",
    ...
    description: "Patient P001 assigned to Room A, bed 101",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    description: "Patient P002 assigned to Room B, bed 102",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    description: "Patient P003 assigned to Room C, bed 103",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    description: "Patient P004 assigned to Room D, bed 104",
    isDefault: false,
    isActive: false,
    isDraft: true,
    createdAt: new Date("2025-04-03"),
    draftedAt: new Date("2025-04-10"),
  ...
  },
  {
    ...
    description: "Patient P005 assigned to Room E, bed 105",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    description: "Patient P006 assigned to Room F, bed 106",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    description: "Patient P007 assigned to Room G, bed 107",
    isDefault: false,
    isActive: false,
    isDraft: true,
    createdAt: new Date("2025-07-01"),
    draftedAt: new Date("2025-07-07"),
  ...
  },
  {
    ...
    description: "Patient P008 assigned to Room H, bed 108",
    isDefault: true,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    description: "Patient P009 assigned to Room I, bed 109",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    description: "Patient P010 assigned to Room J, bed 110",
    isDefault: false,
    isActive: true,
    isDraft: false,
...
export default function ComponentLevelGridView({
  ...
  const [gridData, setGridData] = useState(moduleData);
  ...
  const loadMoreData = useCallback(async () => {
    ...
    const newItems = Array.from({ length: ITEMS_PER_PAGE }, (_, index) => ({
      ...moduleData[index % moduleData.length],
      id: `${Date.now()}-${index}`,
      isDefault: false,
        ...
        >
          <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 pb-4 p-2">
            {filteredData.map((item, index) => (
              ...
              >
                {/* Top Row - Grid with 2 columns: Facility Name | Status */}
                ...
                {/* Middle Row - Facility Type and Description */}
                <div className="mb-3">
                ...
                {/* Bottom Row - Grid with 3 columns: Type | Actions | Default */}
