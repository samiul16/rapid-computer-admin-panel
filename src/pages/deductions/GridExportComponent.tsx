...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "deductions.csv");
  const handleExcel = () => exportToExcel(mockData, "deductions.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          subtitle="Deduction Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "deductions-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
