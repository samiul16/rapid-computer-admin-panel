...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "brands.csv");
  const handleExcel = () => exportToExcel(mockData, "brands.xlsx");
