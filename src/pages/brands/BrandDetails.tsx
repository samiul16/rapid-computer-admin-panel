...
import { mockBrandsHistoryData } from "@/mockData/brands-history-mockdata";
...
export default function BrandDetails() {
    ...
    try {
      ...
      const blob = await pdf(
        <PDF
          data={[viewData]}
          title="Brand Details"
          subtitle="Brand Information Report"
        />
      ).toBlob();
  ...
  return (
    <>
      <PageLayout
        title={t("button.viewingBrand")}
        videoSrc={video}
        videoHeader="Rapid ERP Video"
        onListClick={() => navigate("/brands")}
        listText="List"
        listPath="/brands"
        popoverOptions={[
          {
      ...
      >
        ...
        <Modal.Body>
          <HistoryDataTable columnData={mockBrandsHistoryData} />
        </Modal.Body>
      </Modal>
    </>
  );
