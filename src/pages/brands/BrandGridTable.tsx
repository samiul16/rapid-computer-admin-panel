...
export const brandDataMockData: BrandType[] = [
  {
    id: "brand-001",
    name: "Nike",
    code: "NIKE",
    description:
      "Leading sportswear and athletic brandLeading sportswear and athletic brandLeading sportswear and athletic brandLeading sportswear and athletic brandLeading sportswear and athletic brand",
  ...
  },
  {
    ...
    name: "Under Armour",
    code: "UA",
    description: "American brand known for performance apparel",
    image: "/customer-dummy-image.jpg",
    status: "active",
    isDeleted: false,
  },
  ...
  },
  {
    ...
    name: "New Balance",
    code: "NB",
    description: "Comfort-focused athletic footwear and clothing",
    status: "inactive",
    isDeleted: false,
    image: "/customer-dummy-image.jpg",
  },
  {
    ...
    name: "Asics",
    code: "ASICS",
    description: "Japanese sports equipment and footwear company",
    status: "active",
    isDeleted: false,
    image: "/customer-dummy-image.jpg",
  },
  {
    ...
    name: "Fila",
    code: "FILA",
    description: "Lifestyle and sportswear brand from South Korea",
    status: "draft",
    isDeleted: true,
    image: "/customer-dummy-image.jpg",
  },
...
export default function BrandGridTable({
  setViewMode,
}: {
  ...
  const [gridData, setGridData] = useState(brandDataMockData);
  ...
  const loadMoreData = useCallback(async () => {
    ...
    const newItems = Array.from({ length: ITEMS_PER_PAGE }, (_, index) => ({
      id: `${Date.now()}-${index}`,
      name: `Brand${gridData.length + index + 1}`,
      code: `BR${gridData.length + index + 1}`,
    ...
    if (gridData.length >= 46) {
      ...
      setGridData((prev) => [...prev, ...(newItems as BrandType[])]);
      setPage((prev) => prev + 1);
    }
    ...
    setGridData((prev) =>
      prev.map((brand) =>
        brand.id === id
          ? {
              ...brand,
              isDeleted: brand.isDeleted === true ? false : true,
            }
          : brand
      )
    );
  ...
  return (
    <div className="px-4 py-3 h-full flex flex-col bg-white dark:bg-gray-900 parent">
              ...
              >
                        ...
                        onClick={() => {
                          ...
                          toastSuccess(
                            item.status === "active"
                              ...
                              : "Brand inactivated successfully"
                          );
                        }}
                      >
                        {item.status === "active" ? (
                ...
                <div className="grid grid-cols-1 items-center gap-4 pt-2 dark:border-gray-700">
                  <div className="text-left">
                    ...
                    <div className="text-sm font-semibold text-gray-900 line-clamp-2 dark:text-gray-100">
                      {item.description}
                    </div>
                  </div>
                </div>
      ...
      <Modal
        ...
        title={
          <div className="">
            <h3 className="text-lg font-semibold pl-4">Import Brand</h3>
          </div>
        }
        size="xl"
        overlayProps={{
