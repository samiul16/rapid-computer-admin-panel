...
export default function BrandCreatePage({ isEdit = false }: Props) {
  ...
  return (
    <>
      <PageLayout
        title={isEdit ? t("form.editingBrand") : t("form.creatingBrand")}
        videoSrc={video}
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
            ...
            <div className="md:col-span-3 space-y-2">
              ...
              <EditableInput
                ...
                tooltipText="Please enter brand description"
                required
              />
            </div>
          </div>
