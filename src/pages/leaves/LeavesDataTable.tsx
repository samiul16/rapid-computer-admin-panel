...
export default function LeavesDataTable({
  ...
  const componentColumns = [
    {
      accessorKey: "leaveTypes",
      title: "Leave Types",
      options: [...new Set(mockLeaves.map((item) => item.leaveTypes))],
      ...
      sortingFn: (row1: any, row2: any) => {
        return row1
          .getValue("leaveTypes")
          .localeCompare(row2.getValue("leaveTypes"));
      },
      size: 150,
      minSize: 120,
      meta: {
        exportLabel: "leaveTypes",
        readOnly: !canCreate,
      },
    },
    {
      accessorKey: "notes",
      title: "Notes",
      options: [...new Set(mockLeaves.map((item) => item.notes))],
      filterFn: (row: any, columnId: any, filterValue: any) => {
        if (!filterValue || filterValue.length === 0) return true;
        const cellValue = row.getValue(columnId) as string;
        return filterValue.some((filterVal: string) =>
  ...
  return (
    <FixedColumnDataTable
      ...
      fixedColumns={["leaveTypes"]} // Pin leave types column
      pathName="leaves"
