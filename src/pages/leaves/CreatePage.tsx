...
export default function LeavesFormPage({ isEdit = false }: Props) {
  ...
  const canView = usePermission("leaves", "view");
  ...
  const leaveTypes: boolean = usePermission("leaves", "create", "leaveTypes");
  const notes: boolean = usePermission("leaves", "create", "notes");
  const isDefault: boolean = usePermission("leaves", "create", "isDefault");
  const isDraft: boolean = usePermission("leaves", "create", "isDraft");
