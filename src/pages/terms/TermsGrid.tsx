...
const projectTypeData: GridDataType[] = [
  {
    id: "1",
    code: "PRJ-001",
    termsConditions: "Terms & Conditions 1",
    isDefault: true,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    id: "2",
    code: "PRJ-002",
    termsConditions: "Terms & Conditions 2",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    id: "3",
    code: "PRJ-003",
    termsConditions: "Terms & Conditions 3",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    id: "4",
    code: "PRJ-004",
    termsConditions: "Terms & Conditions 4",
    isDefault: false,
    isActive: false,
    isDraft: true,
  ...
  },
  {
    id: "5",
    code: "PRJ-005",
    termsConditions: "Terms & Conditions 5",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    id: "6",
    code: "PRJ-006",
    termsConditions: "Terms & Conditions 6",
    isDefault: false,
    isActive: false,
    isDraft: false,
  ...
  },
  {
    id: "7",
    code: "PRJ-007",
    termsConditions: "Terms & Conditions 7",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    id: "8",
    code: "PRJ-008",
    termsConditions: "Terms & Conditions 8",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    id: "9",
    code: "PRJ-009",
    termsConditions: "Terms & Conditions 9",
    isDefault: false,
    isActive: false,
    isDraft: true,
  ...
  },
  {
    id: "10",
    code: "PRJ-010",
    termsConditions: "Terms & Conditions 10",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    id: "11",
    code: "PRJ-011",
    termsConditions: "Terms & Conditions 11",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    id: "12",
    code: "PRJ-012",
    termsConditions: "Terms & Conditions 12",
    isDefault: false,
    isActive: false,
    isDraft: false,
...
export default function TermsGrid({
  ...
  const canDelete: boolean = usePermission("terms", "delete");
  const canRestore: boolean = usePermission("terms", "restore");
  const canEdit: boolean = usePermission("terms", "edit");

  // Debug permissions
  console.log("Terms Permissions:", {
    canDelete,
    canRestore,
    canEdit,
  });
  ...
  const loadMoreData = useCallback(async () => {
    ...
    const newItems = Array.from({ length: ITEMS_PER_PAGE }, (_, index) => ({
      id: `${Date.now()}-${index}`,
      code: `TRA-00${index + 1}`,
      termsConditions: `Terms Conditions ${index + 1}`,
      isDefault: false,
  ...
  const filteredData = gridData.filter(
    (item) =>
      item.termsConditions.toLowerCase().includes(searchQuery.toLowerCase()) ||
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Total {gridData.length} Terms & Conditions
        </span>
      </div>
                      ...
                      <button
                        ...
                        onClick={() => {
                          if (canRestore && item.isDeleted) {
                            ...
                            toastRestore(
                              "Terms & Conditions restored successfully"
                            );
                          } else {
                            if (canDelete) {
          ...
          {!hasMore && gridData.length > 12 && (
            <div className="flex justify-center items-center py-8">
              <span className="text-sm text-gray-500 dark:text-gray-400">
                No more terms & conditions to load
              </span>
            </div>
          )}
        </div>
