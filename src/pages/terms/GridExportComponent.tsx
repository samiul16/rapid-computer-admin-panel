...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "terms.csv");
  const handleExcel = () => exportToExcel(mockData, "terms.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          title="Terms Details"
          subtitle="Terms Information Report"
        />
      ).toBlob();
