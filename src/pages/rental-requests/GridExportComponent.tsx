...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "rental-requests.csv");
  const handleExcel = () => exportToExcel(mockData, "rental-requests.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          subtitle="Rental Requests Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "rental-requests-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
