...
const transferCashData: GridDataType[] = [
  {
    branch: "Dhaka Main",
    ...
    draftedAt: null,
    updatedAt: new Date("2025-08-01T10:30:00"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    ...
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-08-02T14:45:00"),
    draftedAt: null,
    updatedAt: new Date("2025-08-02T14:45:00"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    ...
    draftedAt: null,
    updatedAt: new Date("2025-08-03T09:15:00"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    ...
    draftedAt: null,
    updatedAt: new Date("2025-08-04T12:00:00"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    ...
    draftedAt: new Date("2025-08-05T08:45:00"),
    updatedAt: new Date("2025-08-05T08:45:00"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    ...
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-08-06T11:30:00"),
    draftedAt: null,
    updatedAt: new Date("2025-08-06T11:30:00"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    ...
    draftedAt: null,
    updatedAt: new Date("2025-08-07T16:20:00"),
    deletedAt: new Date("2025-08-08T09:00:00"),
    isDeleted: true,
  },
  {
    branch: "Sylhet Branch",
    ...
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-08-08T13:15:00"),
    draftedAt: null,
    updatedAt: new Date("2025-08-08T13:15:00"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    ...
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-08-09T09:40:00"),
    draftedAt: null,
    updatedAt: new Date("2025-08-09T09:40:00"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    ...
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-08-10T10:50:00"),
    draftedAt: null,
    updatedAt: new Date("2025-08-10T10:50:00"),
    deletedAt: null,
    isDeleted: false,
  },
  {
  ...
  },
  {
    ...
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-08-12T15:00:00"),
    draftedAt: null,
    updatedAt: new Date("2025-08-12T15:00:00"),
    deletedAt: null,
    isDeleted: false,
  },
];
...
export default function CashGrid({
  ...
  const [gridData, setGridData] = useState(transferCashData);
  const canDelete: boolean = usePermission("transferCash", "delete");
  const canRestore: boolean = usePermission("transferCash", "restore");
  const canEdit: boolean = usePermission("transferCash", "edit");

  // Debug permissions
  console.log("Transfer Cash Permissions:", {
    canDelete,
    canRestore,
    canEdit,
  });
  ...
  const loadMoreData = useCallback(async () => {
    ...
    const newItems = Array.from({ length: ITEMS_PER_PAGE }, (_, index) => ({
      ...
      transferFrom: `Transfer From ${index + 1}`,
      transferTo: `Transfer To ${index + 1}`,
      transferAmount: `Transfer Amount ${index + 1}`,
      isDefault: false,
  ...
  const filteredData = gridData.filter(
    (item) =>
      ...
      item.transferTo.toLowerCase().includes(searchQuery.toLowerCase())
  );
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Total {gridData.length} Transfer Cash
        </span>
      </div>
              ...
              >
                ...
                <div className="grid grid-cols-2 items-center gap-2 mb-4">
                  ...
                  <CardTitle
                    ...
                    onClick={() => navigate(`/transfer-cash/1`)}
                  >
                    {item.branch}
                  </CardTitle>
                      ...
                      <button
                        ...
                        onClick={() => {
                          if (canRestore && item.isDeleted) {
                            ...
                            toastRestore("Transfer Cash restored successfully");
                          } else {
                            if (canDelete) {
                              handleDeleteClick(item.id);
                              toastDelete("Transfer Cash deleted successfully");
                            }
                          }
                        }}
                      >
          ...
          {isLoading && (
            <div className="flex justify-center items-center py-8">
              <div className="flex items-center gap-2 text-blue-600">
                ...
                <span className="text-sm">Loading more transfer cash...</span>
              </div>
            </div>
          )}
