...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "transfer-cash.csv");
  const handleExcel = () => exportToExcel(mockData, "transfer-cash.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          subtitle="Transfer Cash Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "transfer-cash-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
