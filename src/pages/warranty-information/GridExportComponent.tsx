...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "warranty-information.csv");
  const handleExcel = () =>
    exportToExcel(mockData, "warranty-information.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          title="Warranty Information Details"
          subtitle="Warranty Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "warranty-information-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
