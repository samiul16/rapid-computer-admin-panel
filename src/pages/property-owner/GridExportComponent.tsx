...
const mockData = [
  {
    ...
    whatsappUrl: "https://wa.me/551112345678",
    billingStreet: "123 Billing Rd",
    billingCity: "São Paulo",
    billingState: "SP",
    billingZipCode: "01311-200",
    billingCountry: "Brazil",
    shippingStreet: "456 Shipping Rd",
    shippingCity: "São Paulo",
    shippingState: "SP",
    shippingZipCode: "01311-201",
...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "property-owner.csv");
  const handleExcel = () => exportToExcel(mockData, "property-owner.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          subtitle="Property Owner Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "property-owner-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
