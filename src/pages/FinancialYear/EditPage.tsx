...
const initialData: FinancialYearData = {
  title: "2020 - 2021 Financial Report",
  fromDate: "05-01-2020",
  toDate: "04-30-2021",
  status: "",
  isDefault: false,
...
export default function FinancialYearEditPage({ isEdit = false }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (printEnabled) {
      handlePrintFinancialYear(formData);
    }
    if (keepCreating) {
      handleReset();
    ...
    toastSuccess("FinancialYear Edited successfully");
  };
        ...
        return [
          ...filteredOptions,
          {
            ...
            onClick: () => {
              ...
              toastRestore("FinancialYear saved as draft successfully");
            },
          },
        ];
      }
