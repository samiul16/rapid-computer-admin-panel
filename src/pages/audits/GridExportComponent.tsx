...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "audits.csv");
  const handleExcel = () => exportToExcel(mockData, "audits.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          subtitle="Audits Information Report"
        />
      ).toBlob();
