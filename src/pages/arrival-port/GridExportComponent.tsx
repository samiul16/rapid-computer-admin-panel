...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "arrival-port.csv");
  const handleExcel = () => exportToExcel(mockData, "arrival-port.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          subtitle="Arrival Port Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "arrival-port-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
