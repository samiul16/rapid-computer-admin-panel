...
export default function RepairJobsFormPage({ isEdit = false }: Props) {
  ...
  const canDelete = usePermission("repairJobs", "delete");
  ...
  const device: boolean = usePermission("repairJobs", "create", "device");
  ...
  const mechanic: boolean = usePermission("repairJobs", "create", "mechanic");
  const customer: boolean = usePermission("repairJobs", "create", "customer");
  const status: boolean = usePermission("repairJobs", "create", "status");
  const reference: boolean = usePermission("repairJobs", "create", "reference");
  const discount: boolean = usePermission("repairJobs", "create", "discount");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (keepCreating) {
      toastSuccess("Repair job created successfully!");
      handleReset();
    } else {
      toastSuccess("Repair job created successfully!");
