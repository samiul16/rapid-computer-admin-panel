...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "deprecations.csv");
  const handleExcel = () => exportToExcel(mockData, "deprecations.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          title="Depreciations Details"
          subtitle="Depreciations Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "deprecations-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
