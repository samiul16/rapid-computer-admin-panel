...
import CandidateSortlistsGrid from "./CandidateSortlistsGrid";
import CandidateSortlistsDataTable from "./CandidateSortlistsDataTable";
...
export default function CandidateSortlistsPage() {
  ...
  return (
    <div className="w-100vw px-2 py-4 dark:bg-gray-900">
      ...
      <PageHeader
        ...
        title="Candidate Sortlists"
        createPath="/candidate-sortlists/create"
      />
