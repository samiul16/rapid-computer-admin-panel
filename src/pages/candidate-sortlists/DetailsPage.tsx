...
export default function CandidateSortlistDetails() {
  ...
  // get permission
  const canCreate: boolean = usePermission("candidateSortlists", "create");
  const canView: boolean = usePermission("candidateSortlists", "view");
  ...
  const canExport: boolean = usePermission("candidateSortlists", "export");
  const canPdf: boolean = usePermission("candidateSortlists", "pdf");
  const canPrint: boolean = usePermission("candidateSortlists", "print");
  const canSeeHistory: boolean = usePermission("candidateSortlists", "history");
  ...
  const canViewShortlistedDate: boolean = usePermission(
    "candidateSortlists",
    "view",
    "shortlistedDate"
  );
  ...
  const getLeavesData = (leaveType: string): TermsData => {
    const leavesMap: Record<string, TermsData> = {
      ...
      "Someone I dont Know": {
        candidateName: "Someone I dont Know",
        shortlistedDate: "2024-01-15",
        interviewDate: "2024-01-15",
  ...
  return (
    <>
      <PageLayout
        title="Viewing Candidate Sortlist"
        videoSrc={video}
        videoHeader="Tutorial video"
        onListClick={() => navigate("/candidate-sortlists")}
        listText="List"
        ...
        popoverOptions={[
          {
            ...
            onClick: () => navigate("/candidate-sortlists/create"),
          },
          {
            label: "Edit",
            icon: <Edit className="w-5 h-5 text-blue-600" />,
            onClick: () => navigate("/candidate-sortlists/edit/1"),
          },
        ]}
      ...
      >
        <div dir={isRTL ? "rtl" : "ltr"}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
            ...
            {canViewShortlistedDate && (
              <div className="">
                <h3 className="font-normal mb-1 text-gray-600">
                  Shortlisted Date
                </h3>
                <div className="w-full py-1 text-gray-900 font-bold text-md dark:text-white">
                  {displayValue(leavesData.shortlistedDate)}
                </div>
              </div>
            )}
            ...
            {canViewInterviewDate && (
              <div className="">
                ...
                <div className="w-full py-1 text-gray-900 font-bold text-md dark:text-white">
                  {displayValue(leavesData.interviewDate)}
                </div>
              </div>
            )}
