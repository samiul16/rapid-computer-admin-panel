...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "candidate-sortlists.csv");
  const handleExcel = () => exportToExcel(mockData, "candidate-sortlists.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          title="Candidate Sortlists Details"
          subtitle="Candidate Sortlists Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "candidate-sortlists-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
