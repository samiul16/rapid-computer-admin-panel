...
export const bonusTypeData: GridDataType[] = [
  {
    id: "1",
    bonusType: "Referral",
    description: "Bonus for referring new customers",
    isDefault: true,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    draftedAt: new Date("2025-02-01T12:00:00Z"),
  ...
  },
  {
    id: "4",
    bonusType: "Holiday",
    description: "Special holiday campaign bonus",
    isDefault: false,
    isActive: false,
    isDraft: false,
    ...
    deletedAt: new Date("2024-12-01T09:00:00Z"),
    isDeleted: true,
  },
  {
    id: "5",
  ...
  },
  {
    id: "6",
    bonusType: "Milestone",
    description: "Bonus for achieving milestones",
    isDefault: false,
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-02-05T13:00:00Z"),
    draftedAt: null,
    updatedAt: new Date("2025-02-07T09:30:00Z"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    id: "7",
    bonusType: "Birthday",
    description: "Special gift on birthday",
    isDefault: false,
    isActive: true,
    isDraft: false,
    createdAt: new Date("2024-12-10T15:20:00Z"),
    draftedAt: null,
  ...
  },
  {
    ...
    draftedAt: new Date("2025-02-15T10:00:00Z"),
  ...
  },
  {
    ...
    description: "Celebration bonus for anniversaries",
    isDefault: false,
    isActive: true,
    isDraft: false,
    createdAt: new Date("2024-09-20T09:00:00Z"),
    draftedAt: null,
    updatedAt: new Date("2024-09-25T12:00:00Z"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    id: "11",
    bonusType: "Feedback",
    description: "Reward for customer feedback",
    isDefault: false,
    isActive: false,
    isDraft: false,
  ...
  },
  {
    id: "12",
    bonusType: "Survey",
    description: "Survey participation bonus",
    isDefault: false,
    isActive: false,
    isDraft: false,
    ...
    deletedAt: new Date("2024-08-10T09:00:00Z"),
    isDeleted: true,
  },
];
...
export default function ComponentLevelGridView({
  ...
  const [gridData, setGridData] = useState(bonusTypeData);
