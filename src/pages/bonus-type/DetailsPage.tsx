...
const autocompleteDataDetailsPage = ["Bonus Type 1", "Bonus Type 2"];
...
export default function BonusTypeDetails() {
  ...
  const getLeavesData = (leaveType: string): DetailsPageTypes => {
    const leavesMap: Record<string, DetailsPageTypes> = {
      "Bonus Type 1": initialData,
      "Bonus Type 2": initialData,
    };
