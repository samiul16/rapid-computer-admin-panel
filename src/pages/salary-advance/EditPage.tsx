...
export default function LeavesEditPage({ isEdit = false }: Props) {
  ...
  const date: boolean = usePermission("salaryAdvance", "edit", "date");
  const iqamaNo: boolean = usePermission("salaryAdvance", "edit", "iqamaNo");
  const branch: boolean = usePermission("salaryAdvance", "edit", "branch");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toastSuccess("Salary advance edited successfully");
  };
