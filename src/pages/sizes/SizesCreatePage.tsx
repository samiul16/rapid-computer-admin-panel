...
export default function SizesCreatePage({ isEdit = false }: Props) {
  ...
  return (
    <>
      <PageLayout
        title={isEdit ? t("form.editingSize") : t("form.creatingSize")}
        videoSrc={video}
      ...
      >
        <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
            ...
            <div className="md:col-span-3 space-y-2">
              <h3 className="font-medium mb-1">{t("form.value")}</h3>
              <EditableInput
                type="text"
                id="value"
                name="value"
                ...
                setRef={setRef("value")}
                tooltipText="Please enter value"
                required
              />
            </div>
