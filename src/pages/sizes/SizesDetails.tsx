...
import { mockSizeHistoryData } from "@/mockData/sizes-histiry-mockdata";
...
export default function SizesDetails() {
    ...
    try {
      ...
      const blob = await pdf(
        <PDF
          data={[viewData]}
          title="Size Details"
          subtitle="Size Information Report"
        />
      ).toBlob();
  ...
  return (
    <>
      <PageLayout
        title={t("button.viewingSize")}
        videoSrc={video}
        videoHeader="Rapid ERP Video"
        onListClick={() => navigate("/sizes")}
        listText="List"
        listPath="/sizes"
        popoverOptions={[
          {
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
          ...
          <div className="md:col-span-3">
            <h3 className="font-medium mb-1">Size Name</h3>
      ...
      >
        ...
        <Modal.Body>
          <HistoryDataTable columnData={mockSizeHistoryData} />
        </Modal.Body>
      </Modal>
    </>
  );
