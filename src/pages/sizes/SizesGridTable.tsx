...
export const gridCardData: GridCardDataType[] = [
  ...
  },
  {
    ...
    code: "XL",
    value: "40x28 cm",
    description: "Extra large for oversize items",
    status: "draft",
    isDeleted: false,
  },
  {
    ...
    code: "XS",
    value: "24x18 cm",
    description: "Smallest available size",
    status: "active",
    isDeleted: false,
  },
  {
    ...
    code: "XXL",
    value: "44x30 cm",
    description: "Largest standard size",
    status: "active",
    isDeleted: false,
  },
  {
    ...
    code: "UNI",
    value: "Flexible",
    description: "Stretchable or adjustable size",
    status: "inactive",
    isDeleted: false,
  },
  {
    ...
    code: "ONE",
    value: "Fits All",
    description: "Universal size for accessories",
    status: "active",
    isDeleted: false,
  },
];

export default function SizesGridTable({
  setViewMode,
}: {
  ...
  return (
    <div className="px-4 py-3 h-full flex flex-col bg-white dark:bg-gray-900 parent">
          ...
          {isLoading && (
            <div className="flex justify-center items-center py-8">
              <div className="flex items-center gap-2 text-blue-600">
                ...
                <span className="text-sm">Loading more sizes...</span>
              </div>
            </div>
          )}
      ...
      <Modal
        ...
        title={
          <div className="">
            <h3 className="text-lg font-semibold pl-4">Import Sizes</h3>
          </div>
        }
        size="xl"
        overlayProps={{
