...
const mockData = [
  ...
  },
  {
    ...
    roomSize: " ( 5000 x 4200 ) ",
    status: "archived",
    isDeleted: false,
  },
  {
    id: "5",
    description: "Paris, small café shop interior",
    roomSize: " ( 1500 x 1200 ) ",
    status: "archived",
    isDeleted: false,
  },
  {
  ...
  },
  {
    ...
    roomSize: " ( 2400 x 2000 ) ",
    status: "archived",
    isDeleted: false,
  },
  {
    id: "9",
    description: "Bangkok, open-air rooftop bar",
    roomSize: " ( 3500 x 2800 ) ",
    status: "archived",
    isDeleted: false,
  },
  {
    id: "10",
    description: "San Francisco, coworking space",
    roomSize: " ( 3000 x 2500 ) ",
    status: "upcoming",
    isDeleted: false,
  },
  {
...
export default function RoomSizeGrid({
  searchQuery,
  setIsFilterOpen,
  isFilterOpen,
  setIsExportOpen,
  ...
  const canRestore: boolean = usePermission("roomSize", "restore");
  ...
  const loadMoreData = useCallback(async () => {
    ...
    const newItems = Array.from({ length: ITEMS_PER_PAGE }, (_, index) => ({
      ...
      roomSize: `Room Size ${Date.now()}-${index}`,
      status: "active",
      isDeleted: false,
    }));
  ...
  const filteredRoomSize = RoomSizeData.filter((roomSize) =>
    roomSize.roomSize.toLowerCase().includes(searchQuery.toLowerCase())
  );
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Total {filteredRoomSize.length} Room Size
        </span>
      </div>
