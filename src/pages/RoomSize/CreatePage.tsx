...
export default function RoomSizeCreatePage({ isEdit = false }: Props) {
  ...
  const name: boolean = usePermission("roomSize", "create", "name");

  const isDefault: boolean = usePermission("roomSize", "create", "isDefault");
  const isDraft: boolean = usePermission("roomSize", "create", "isDraft");
  ...
  const [popoverOptions, setPopoverOptions] = useState([
    {
      ...
      onClick: () => {
        if (isEdit) {
          navigate("/room-size/create");
        } else {
          navigate("/room-size/edit/undefined");
        }
      },
  ...
  const handleReset = () => {
    ...
    setTimeout(() => {
      inputRefs.current["roomSize"]?.focus();
  ...
  return (
    <>
      <PageLayout
        title={isEdit ? labels.editingRoomSize : labels.creatingRoomSize}
        videoSrc={video}
