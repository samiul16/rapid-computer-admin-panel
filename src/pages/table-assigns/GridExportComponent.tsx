...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "table-assigns.csv");
  const handleExcel = () => exportToExcel(mockData, "table-assigns.xlsx");
  const handleExport = async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = "table-assigns-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
