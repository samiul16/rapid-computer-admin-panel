...
export const plansData: GridDataType[] = [
  ...
  {
    id: "11",
    facilityName: "Security Control Room",
    description:
      "Centralized security monitoring facility with surveillance systems and emergency response",
    isDefault: false,
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-01-01"),
  ...
  {
    id: "12",
    facilityName: "Executive Conference Center",
    description:
      "Premium facility for high-level meetings, boardrooms, and corporate events",
    isDefault: true,
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-01-01"),
