...
export const plansData: GridDataType[] = [
  ...
  {
    id: "11",
    iqmaNumber: "1111111111",
    employeeName: "Sara Al-Mahmoud",
  ...
  {
    id: "12",
    iqmaNumber: "2222222222",
    employeeName: "Hassan Al-Otaibi",
          ...
          <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 pb-4 p-2">
            {filteredData.map((item, index) => (
              ...
              >
                ...
                {/* Bottom Row - Grid with 3 columns: Iqma | Actions | Salary */}
                <div className="grid grid-cols-3 items-center gap-4 pt-2 dark:border-gray-700">
                  {/* Iqma Number - Left aligned */}
                  <div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">
                      Iqma Number
                    </div>
                ...
                <div className="grid grid-cols-2 items-center gap-2 pt-2 dark:border-gray-700 border-t">
                  <div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">
                      Department
                    </div>
