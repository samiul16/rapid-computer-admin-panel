...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "warranties.csv");
  const handleExcel = () => exportToExcel(mockData, "warranties.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          subtitle="Warranties Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "warranties-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
