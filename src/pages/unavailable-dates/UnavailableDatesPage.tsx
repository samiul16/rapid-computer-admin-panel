...
import UnavailableDatesDataTable from "./UnavailableDatesDataTable";
import UnavailableDatesGrid from "./UnavailableDatesGrid";
  ...
  return (
    <div className="w-100vw px-2 py-4 dark:bg-gray-900">
      ...
      <PageHeader
        ...
        createPath="/unavailable-dates/create"
      />
