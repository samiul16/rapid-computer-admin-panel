...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "unavailable-dates.csv");
  const handleExcel = () => exportToExcel(mockData, "unavailable-dates.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          title="Unavailable Dates Details"
          subtitle="Unavailable Dates Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "unavailable-dates-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
