...
export const plansData: GridDataType[] = [
  ...
  },
  {
    ...
    dependantName: "Lisa Anderson",
    relation: "Spouse",
    dateOfBirth: "1989-12-20",
    citizenIdentification: "7788990011",
    reason: "Marriage",
    effectiveDate: "2025-01-01",
    expirationDate: "2025-12-31",
    isDefault: false,
  ...
  },
  {
    ...
    dependantName: "Emma White",
    relation: "Child",
    dateOfBirth: "2019-03-10",
    citizenIdentification: "4455667788",
    reason: "Birth",
    effectiveDate: "2025-01-01",
    expirationDate: "2025-12-31",
    isDefault: true,
        ...
        >
          <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 pb-4 p-2">
            {filteredData.map((item, index) => (
              ...
              >
                {/* Top Row - Grid with 2 columns: Employee Name | Status */}
                ...
                {/* Middle Row - Dependant Name and Relation */}
                <div className="mb-3">
                ...
                {/* Date Row - Date of Birth and Reason */}
                <div className="mb-3">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">
