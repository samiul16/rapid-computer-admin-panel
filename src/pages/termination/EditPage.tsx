...
export default function TerminationEditPage({ isEdit = false }: Props) {
  ...
  const date: boolean = usePermission("termination", "edit", "date");
  const iqamaNo: boolean = usePermission("termination", "edit", "iqamaNo");
  const branch: boolean = usePermission("termination", "edit", "branch");
  ...
  const status: boolean = usePermission("termination", "edit", "status");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toastSuccess("Termination edited successfully");
  };
