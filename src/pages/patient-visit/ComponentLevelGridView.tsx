...
export const plansData: GridDataType[] = [
  ...
  },
  {
    ...
    visitTime: "08:30 PM",
    finding: "Chest pain, difficulty breathing",
    instructions: "Immediate ECG, cardiac monitoring required",
    fees: "250.00",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    visitTime: "01:45 PM",
    finding: "Post-surgery recovery progressing well",
    instructions: "Continue physiotherapy, next follow-up in 2 weeks",
    fees: "130.00",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    visitTime: "10:30 AM",
    finding: "Chronic condition management review",
    instructions: "Adjust treatment plan, schedule next appointment",
    fees: "160.00",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    visitTime: "04:15 PM",
    finding: "Blood pressure elevated, weight gain noted",
    instructions: "Diet modification, increase exercise, monitor BP",
    fees: "140.00",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    visitTime: "11:20 PM",
    finding: "Severe allergic reaction, breathing difficulty",
    instructions: "Immediate antihistamine, monitor for 24 hours",
    fees: "300.00",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    visitTime: "09:00 AM",
    finding: "Annual physical - all systems normal",
    instructions: "Continue healthy lifestyle, next checkup in 1 year",
    fees: "110.00",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    visitTime: "02:00 PM",
    finding: "Medication effectiveness confirmed",
    instructions: "Continue current treatment, reduce dosage gradually",
    fees: "125.00",
    isDefault: true,
    isActive: true,
    isDraft: false,
        ...
        >
          <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 pb-4 p-2">
            {filteredData.map((item, index) => (
              ...
              >
                {/* Top Row - Grid with 2 columns: Visit Type | Patient ID */}
                ...
                {/* Bottom Row - Grid with 3 columns: SL No | Actions | Visit Time */}
