...
export default function MaintenanceFormPage({ isEdit = false }: Props) {
  ...
  const canEdit = usePermission("maintenance", "edit");
  ...
  const vehicle: boolean = usePermission("maintenance", "create", "vehicle");
  const garage: boolean = usePermission("maintenance", "create", "garage");
  ...
  const startDate: boolean = usePermission(
    "maintenance",
    "create",
    "startDate"
  );
  ...
  const parts: boolean = usePermission("maintenance", "create", "parts");
  const cost: boolean = usePermission("maintenance", "create", "cost");
  const description: boolean = usePermission(
    "maintenance",
    "create",
    "description"
  );
  const isDraft: boolean = usePermission("maintenance", "create", "isDraft");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (keepCreating) {
      toastSuccess("Maintenance record created successfully!");
      handleReset();
    } else {
      toastSuccess("Maintenance record created successfully!");
