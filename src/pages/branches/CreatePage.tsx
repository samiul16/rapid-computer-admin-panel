...
export default function BranchFormPage({ isEdit = false }: Props) {
  ...
  useEffect(() => {
    ...
    if (selectedCountry) {
      ...
      if (formData.state && !states.find((s) => s.name === formData.state)) {
        setFormData((prev: Branch) => ({ ...prev, state: "", city: "" }));
        setFilteredCities([]);
      }
    } else {
      setFilteredStates([]);
  ...
  const handleSwitchChange = (checked: boolean) => {
    ...
    if (checked && formData) {
      ...
      setTimeout(() => handlePrintBranch(formData), 100);
    }
  };
  ...
  const handleExportPDF = async () => {
    ...
    try {
      console.log("branchData on pdf click", formData);
  ...
  return (
    <>
      <PageLayout
        title={isEdit ? t("form.editingBranch") : t("form.creatingBranch")}
        videoSrc={video}
        ...
        popoverOptions={[
          {
            ...
            onClick: () => {
              ...
              if (isEdit) {
                ...
                navigate("/branches/edit/undefined");
              }
            },
          },
          {
      ...
      >
        <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
          {/* First Row: Code, Branch Name, Tax Number */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
              ...
              <EditableInput
                ...
                onCancel={() => {}}
                tooltipText="Please enter branch code (e.g., B001, MAIN)"
                required
              />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="space-y-2">
              ...
              <EditableInput
                ...
                onCancel={() => {}}
                tooltipText="Please enter fax number"
              />
            </div>
          ...
          {/* Third Row: Email, Website, Address */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
              ...
              <EditableInput
                ...
                onCancel={() => {}}
                tooltipText="Please enter branch email"
                required
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <EditableInput
                ...
                onCancel={() => {}}
                tooltipText="Please enter branch address"
              />
            </div>
          </div>

          {/* Fourth Row: Country, State, City */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
          ...
          {/* Fifth Row: Post Code, Bank Details */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <h3 className="font-medium mb-1">{t("form.bankDetails")}</h3>
              <EditableInput
      ...
      <LanguageTranslatorModal
        ...
        title="Branch Language Translator"
        initialData={translations}
        onSave={(data) => {
          setTranslations(data);
          console.log("Branch translations saved:", data);
        }}
      />
    </>
  );
