...
export default function PickupEditPage({ isEdit = false }: Props) {
  ...
  // const branch: boolean = usePermission("pickup", "create", "branch");
  ...
  // const category: boolean = usePermission("pickup", "create", "category");
  ...
  // const Pickup: boolean = usePermission("pickup", "create", "Pickup");

  // const date: boolean = usePermission("pickup", "create", "date");
  // const amount: boolean = usePermission("pickup", "create", "amount");
  // const currency: boolean = usePermission("pickup", "create", "currency");
  // const paymentMode: boolean = usePermission(
  //   "pickup",
  //   "create",
  //   "paymentMode"
  // );
  // const vat: boolean = usePermission("pickup", "create", "vat");
  // const supplier: boolean = usePermission("pickup", "create", "supplier");
  // const approvedBy: boolean = usePermission("pickup", "create", "approvedBy");
  ...
  //   "supplierVatNumber"
  // );
  // const PickupBy: boolean = usePermission("pickup", "create", "PickupBy");
  // const PickupFor: boolean = usePermission("pickup", "create", "PickupFor");
  // const note: boolean = usePermission("pickup", "create", "note");

  const isDefault: boolean = usePermission("pickup", "create", "isDefault");

  const isDraft: boolean = usePermission("pickup", "create", "isDraft");
  const isActive: boolean = usePermission("pickup", "create", "isActive");
  const isDeleted: boolean = usePermission("pickup", "create", "isDeleted");
  ...
  // console.log("PickupBy", PickupBy);
  // console.log("PickupFor", PickupFor);
