        ...
        >
          <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 pb-4 p-2">
            {filteredData.map((item, index) => (
              ...
              >
                {/* Top Row - Grid with 2 columns: Invoice Number | Payment Mode */}
                ...
                {/* Bottom Row - Grid with 3 columns: Payment Status | Actions | Total Amount */}
                <div className="grid grid-cols-3 items-center gap-4 pt-2 dark:border-gray-700">
                  {/* Payment Status - Left aligned */}
                  <div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">
                      Status
                    </div>
                    <div
                      className={`text-sm font-semibold truncate ${
                        parseFloat(item.remainingAmount) === 0
                          ? "text-green-600 dark:text-green-400"
                          : parseFloat(item.remainingAmount) >
                            parseFloat(item.amountReceived)
