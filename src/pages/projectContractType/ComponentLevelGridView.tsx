...
export const plansData: GridDataType[] = [
  ...
  {
    id: "3",
    name: "Finance system access issue",
  ...
  {
    id: "4",
    name: "Customer portal login error",
  ...
  {
    id: "5",
    name: "HR policy document update",
  ...
  {
    id: "6",
    name: "Design team software request",
  ...
  {
    id: "7",
    name: "QA test environment issue",
  ...
  {
    id: "11",
    name: "Data analytics dashboard bug",
  ...
  {
    id: "12",
    name: "Project timeline update request",
