...
export default function BenefitPenaltyEditPage({ isEdit = false }: Props) {
  ...
  const type: boolean = usePermission("benefitPenalty", "edit", "type");
  const subject: boolean = usePermission("benefitPenalty", "edit", "subject");
  const criteria: boolean = usePermission("benefitPenalty", "edit", "criteria");
  const date: boolean = usePermission("benefitPenalty", "edit", "date");
  const driver: boolean = usePermission("benefitPenalty", "edit", "driver");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toastSuccess("Benefit/penalty record edited successfully");
  };
                    ...
                    <Autocomplete
                      ...
                      onValueChange={(value: string) => {
                        ...
                        if (value && driverData[value]) {
                          setSelectedDriver(driverData[value]);
