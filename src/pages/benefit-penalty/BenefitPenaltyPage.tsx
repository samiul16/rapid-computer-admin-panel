...
import BenefitPenaltyGrid from "./BenefitPenaltyGrid";
import BenefitPenaltyDataTable from "./BenefitPenaltyDataTable";
  ...
  return (
    <div className="w-100vw px-2 py-4 dark:bg-gray-900">
      ...
      <PageHeader
        ...
        title="Benefit Penalty"
        createPath="/benefit-penalty/create"
      />
