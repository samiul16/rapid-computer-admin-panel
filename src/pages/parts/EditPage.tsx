...
export default function PartsEditPage({ isEdit = false }: Props) {
  ...
  const isActive: boolean = usePermission("parts", "create", "isActive");
  const isDeleted: boolean = usePermission("parts", "create", "isDeleted");
