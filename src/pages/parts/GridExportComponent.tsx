...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "parts.csv");
  const handleExcel = () => exportToExcel(mockData, "parts.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          title="Parts Details"
          subtitle="Parts Information Report"
        />
      ).toBlob();
