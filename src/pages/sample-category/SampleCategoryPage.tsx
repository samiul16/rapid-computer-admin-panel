...
import SampleCategoryGrid from "./SampleCategoryGrid";
import SampleCategoryDataTable from "./SampleCategoryDataTable";
  ...
  return (
    <div className="w-100vw px-2 py-4 dark:bg-gray-900">
      ...
      <PageHeader
        ...
        createPath="/sample-category/create"
      />
