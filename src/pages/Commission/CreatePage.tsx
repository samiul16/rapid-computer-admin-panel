...
export default function CommissionCreatePage({ isEdit = false }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (keepCreating) {
      toastSuccess("Commission Selection created successfully!");
      handleReset();
    } else {
      toastSuccess("Commission Selection created successfully!");
      navigate("/commission");
  ...
  const handleReset = () => {
    ...
    setTimeout(() => {
      inputRefs.current["designation"]?.focus();
    }, 100); // Slightly longer delay to ensure re-render is complete
  };

  const handlePrintIncrements = (CommissionData: any) => {
    try {
      const html = PrintCommonLayout({
        title: "Commission Selection Details",
        data: [CommissionData],
  ...
  const handleExportPDF = async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = "commission-details.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
        ...
        return [
          ...filteredOptions,
          {
            ...
            onClick: () => {
              ...
              toastRestore("Commissionsaved as draft successfully");
            },
  ...
  return (
    <>
      <PageLayout
        title={isEdit ? labels.editingCommission : labels.creatingCommission}
        videoSrc={video}
