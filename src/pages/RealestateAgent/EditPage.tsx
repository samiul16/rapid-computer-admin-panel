...
export default function RealEstateAgentEditPage({ isEdit = false }: Props) {
  ...
  // const branch: boolean = usePermission("realestateAgent", "create", "branch");
  ...
  // const category: boolean = usePermission("realestateAgent", "create", "category");
  ...
  // const expense: boolean = usePermission("realestateAgent", "create", "expense");

  // const date: boolean = usePermission("realestateAgent", "create", "date");
  // const amount: boolean = usePermission("realestateAgent", "create", "amount");
  // const currency: boolean = usePermission("realestateAgent", "create", "currency");
  // const paymentMode: boolean = usePermission(
  //   "realestateAgent",
  //   "create",
  //   "paymentMode"
  // );
  // const vat: boolean = usePermission("realestateAgent", "create", "vat");
  // const supplier: boolean = usePermission("realestateAgent", "create", "supplier");
  // const approvedBy: boolean = usePermission("realestateAgent", "create", "approvedBy");
  ...
  //   "supplierVatNumber"
  // );
  // const expenseBy: boolean = usePermission("realestateAgent", "create", "expenseBy");
  // const expenseFor: boolean = usePermission("realestateAgent", "create", "expenseFor");
  // const note: boolean = usePermission("realestateAgent", "create", "note");
  ...
  useEffect(() => {
    if (isEdit && initialData) {
      ...
      setImagePreview(
        "https://images.ctfassets.net/zuzzsqg9enty/5dw0Zli6kAH32Y0tx10LYe/6a2f5361455e3b7945646dfca1af2191/Willem-Brocker.webp"
      );
  ...
  return (
    <>
      <PageLayout
        title={
          isEdit
            ? labels.editingRealEstateAgent
            : labels.creatingRealEstateAgent
        }
        videoSrc={video}
