...
export default function CandidateSelectionsEditPage({ isEdit = false }: Props) {
  ...
  const handlePrintCandidateSelections = (CandidateSelectionsData: any) => {
    try {
