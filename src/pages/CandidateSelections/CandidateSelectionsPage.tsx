...
import CandidateSelectionsGrid from "./CandidateSelectionsGrid";
import CandidateSelectionsDataTable2 from "./CandidateSelectionsDataTable2";
...
export default function CandidateSelectionsPage() {
  ...
  return (
    <div className="w-100vw px-2 py-4 dark:bg-gray-900">
      ...
      <PageHeader
        ...
        createPath="/candidate-selections/create"
      />
