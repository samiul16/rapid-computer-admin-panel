...
export const plansData: GridDataType[] = [
  ...
  },
  {
    ...
    dischargeDate: "2025-04-18",
    description: "VIP room with premium facilities",
    charge: "3000",
    isDefault: false,
    isActive: false,
    isDraft: true,
  ...
  },
  {
    ...
    roomName: "Room E",
    bedNumber: "301",
    assignDate: "2025-05-03",
    dischargeDate: "2025-05-28",
    description: "General ward bed with shared bathroom",
    charge: "500",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    dischargeDate: "2025-06-22",
    description: "Private cabin with attached AC",
    charge: "2000",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    description: "Deluxe room with visitor area",
    charge: "2500",
    isDefault: false,
    isActive: false,
    isDraft: true,
    createdAt: new Date("2025-07-02"),
    draftedAt: new Date("2025-07-10"),
  ...
  },
  {
    ...
    dischargeDate: "2025-08-25",
    description: "ICU bed with monitoring facilities",
    charge: "5000",
    isDefault: true,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    description: "Neonatal care unit bed",
    charge: "4000",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    description: "Emergency ward bed with oxygen supply",
    charge: "1200",
    isDefault: false,
    isActive: true,
    isDraft: false,
