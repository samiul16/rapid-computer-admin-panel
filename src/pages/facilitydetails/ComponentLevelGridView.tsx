...
export const plansData: GridDataType[] = [
  ...
  },
  {
    ...
    description:
      "Secondary office location for regional operations and client meetings",
    isDefault: false,
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-01-01"),
  ...
  },
  {
    id: "12",
    facilityType: "Manufacturing Plant",
    facilityName: "Assembly Line B",
    description:
      "Secondary production facility for specialized manufacturing processes",
    isDefault: true,
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-01-01"),
