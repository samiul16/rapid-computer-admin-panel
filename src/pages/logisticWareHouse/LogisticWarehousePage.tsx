...
import LogisticWarehouseDataTable from "./DataTable";
import LogisticWarehouseGrid from "./Grid";
...
export default function LogisticWarehousePage() {
  ...
  return (
    <div className="w-100vw px-2 py-4 dark:bg-gray-900">
      ...
      <PageHeader
        ...
        createPath="/logistic-warehouse/create"
      />
