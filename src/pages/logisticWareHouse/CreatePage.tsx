...
export default function LogisticWarehouseCreatePage({ isEdit = false }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (keepCreating) {
      toastSuccess("Logistic Warehouse created successfully!");
      handleReset();
    } else {
      toastSuccess("Logistic Warehouse created successfully!");
        ...
        return [
          ...filteredOptions,
          {
            ...
            onClick: () => {
              ...
              toastRestore("Logistic Warehouse saved as draft successfully");
            },
