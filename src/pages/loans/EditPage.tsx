...
export default function LoansCreatePage({ isEdit = false }: Props) {
  ...
  const isActive: boolean = usePermission("loans", "create", "isActive");
  const isDeleted: boolean = usePermission("loans", "create", "isDeleted");
  ...
  console.log("installmentPeriod", installmentPeriod);
  console.log("repaymentFrom", repaymentFrom);
