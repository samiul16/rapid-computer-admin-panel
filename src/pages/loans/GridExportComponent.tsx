...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "loans.csv");
  const handleExcel = () => exportToExcel(mockData, "loans.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          title="Loan Details"
          subtitle="Loan Information Report"
        />
      ).toBlob();
