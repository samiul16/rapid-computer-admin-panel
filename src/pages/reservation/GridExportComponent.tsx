...
const mockData = [
  {
    ...
    isDraft: false,
    isUpdated: false,
    actionMessage: "Reservation created",
...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "reservations.csv");
  const handleExcel = () => exportToExcel(mockData, "reservations.xlsx");
  const handleExport = async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = "reservations-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
