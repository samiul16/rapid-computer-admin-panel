...
export default function ComponentLevelGridTable({
  ...
  const loadMoreData = useCallback(async () => {
    ...
    const newItems = Array.from({ length: ITEMS_PER_PAGE }, (_, index) => ({
      ...
      name: `Sub Bin Name#${gridData.length + index + 1}`,
  ...
  return (
    <div className="px-4 py-3 h-full flex flex-col bg-white dark:bg-gray-900 parent">
                    ...
                    >
                      <div
                        ...
                        onClick={() => {
                          ...
                          toastSuccess(
                            item.status === "active"
                              ? "Sub Bin activated successfully"
                              : "Sub Bin inactivated successfully"
                          );
                        }}
                      >
                        {item.status === "active" ? (
                    ...
                    >
                      <div
                        ...
                        onClick={() => {
                          ...
                          toastSuccess(
                            item.isDeleted
                              ? "Sub Bin restored successfully"
                              : "Sub Bin deleted successfully"
                          );
                        }}
                      >
                        {item.isDeleted ? (
          ...
          {isLoading && (
            <div className="flex justify-center items-center py-8">
              <div className="flex items-center gap-2 text-blue-600">
                ...
                <span className="text-sm">Loading more sub bin...</span>
              </div>
            </div>
          )}
      ...
      <Modal
        ...
        title={
          <div className="">
            <h3 className="text-lg font-semibold pl-4">Import Sub Bin</h3>
          </div>
        }
        size="xl"
        overlayProps={{
