...
import LeavesApprovalGrid from "./LeavesApprovalGrid";
import LeavesApprovalDataTable from "./LeavesApprovalDataTable";
  ...
  return (
    <div className="w-100vw px-2 py-4 dark:bg-gray-900">
      ...
      <PageHeader
        ...
        createPath="/leaves-approval/view"
      />
