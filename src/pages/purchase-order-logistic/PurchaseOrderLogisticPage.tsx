...
import PurchaseOrderLogisticGrid from "./PurchaseOrderLogisticGrid";
import PurchaseOrderLogisticDataTable from "./PurchaseOrderLogisticDataTable";
...
export default function SampleCategoryPage() {
  ...
  const moduleName = "Purchase Order Logistic";
  const pathName = "purchase-order-logistic";
  ...
  // Updated mock data for consistency
    ...
    viewMode === "grid" ? (
      ...
      >
        <div className="overflow-y-auto overflow-x-hidden scroll-smooth [scrollbar-gutter:stable] h-full">
          <PurchaseOrderLogisticDataTable
            viewMode={viewMode}
            searchQuery={searchQuery}
            setViewMode={setViewMode}
            dataTableFilter={dataTableFilter}
