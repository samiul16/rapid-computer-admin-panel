...
export default function PromotionEditPage({ isEdit = false }: Props) {
  ...
  const handlePrintPromotion = (promotionData: Promotion) => {
    try {
    ...
    <>
      ...
      >
        <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
          {/* First Row: Code, Employee Name, From Position */}
          ...
          {/* Second Row: To Position, From Department, To Department */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
          ...
          {/* Third Row: From Salary, To Salary, Promotion Date */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
          ...
          {/* Fourth Row: Effective Date, Approved By, Reason */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
          ...
          {/* Sixth Row: Default, Active, Draft, Delete */}
