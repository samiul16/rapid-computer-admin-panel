...
export const plansData: GridDataType[] = [
  ...
  },
  {
    ...
    availableTime: "09:30 AM - 05:30 PM",
    perPatientTime: "35 minutes",
    serialVisibility: "Visible",
    status: "Active",
    isDefault: false,
    isActive: true,
  ...
  },
  {
    ...
    availableTime: "10:30 AM - 06:30 PM",
    perPatientTime: "50 minutes",
    serialVisibility: "Visible",
    status: "Active",
    isDefault: false,
    isActive: true,
  ...
  },
  {
    ...
    availableTime: "07:30 AM - 03:30 PM",
    perPatientTime: "15 minutes",
    serialVisibility: "Visible",
    status: "Active",
    isDefault: false,
    isActive: true,
  ...
  },
  {
    ...
    availableTime: "09:15 AM - 05:15 PM",
    perPatientTime: "55 minutes",
    serialVisibility: "Hidden",
    status: "Active",
    isDefault: false,
    isActive: true,
  ...
  },
  {
    ...
    availableTime: "08:15 AM - 04:15 PM",
    perPatientTime: "30 minutes",
    serialVisibility: "Visible",
    status: "Active",
    isDefault: false,
  ...
  },
  {
    ...
    availableTime: "10:15 AM - 06:15 PM",
    perPatientTime: "45 minutes",
    serialVisibility: "Visible",
    status: "Active",
    isDefault: true,
          ...
          <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 pb-4 p-2">
            {filteredData.map((item, index) => (
              ...
              >
                ...
                {/* Middle Row - Available Time & Per Patient Time */}
                <div className="mb-3">
                ...
                {/* Bottom Row - Grid with 3 columns: Serial Visibility | Actions | Default */}
                <div className="grid grid-cols-3 items-center gap-4 pt-2 dark:border-gray-700">
                  {/* Serial Visibility - Left aligned */}
                  <div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">
                      Serial Visibility
                    </div>
                    <div className="text-sm font-semibold text-gray-900 dark:text-gray-100 truncate">
                      {item.serialVisibility}
                    </div>
                  </div>
