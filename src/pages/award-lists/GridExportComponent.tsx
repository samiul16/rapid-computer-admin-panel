...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "award-lists.csv");
  const handleExcel = () => exportToExcel(mockData, "award-lists.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          subtitle="Award Lists Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "award-lists-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
