...
export default function AppointmentEditPage({ isEdit = false }: Props) {
  ...
  const name: boolean = usePermission("appointments", "edit", "name");
  const mobile: boolean = usePermission("appointments", "edit", "mobile");
  const email: boolean = usePermission("appointments", "edit", "email");
        ...
        <div dir={isRTL ? "rtl" : "ltr"}>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 my-8 relative">
              {/* Name field - only show if user can edit */}
              {name && (
              ...
              {/* Appointment Date field - only show if user can edit */}
              {appointmentDate && (
                <div className="space-y-2">
                  <EditableInput
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 my-8 relative">
              {/* Appointment Time field - only show if user can edit */}
              {appointmentTime && (
                <div className="space-y-2">
                  <EditableInput
              ...
              {/* Appointment By field - only show if user can edit */}
              {appointmentBy && (
                <div className="space-y-2">
                  <div className="relative">
                    <Autocomplete
