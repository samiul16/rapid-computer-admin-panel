...
const noticeData: GridDataType[] = [
  ...
  },
  {
    ...
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-02-18T10:30:00Z"),
    draftedAt: null,
    updatedAt: new Date("2025-02-18T10:30:00Z"),
    deletedAt: null,
    isDeleted: false,
  },
  {
  ...
  },
  {
    ...
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-04-02T09:30:00Z"),
    draftedAt: null,
  ...
  },
  {
    ...
    draftedAt: null,
    updatedAt: new Date("2025-04-15T14:00:00Z"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    ...
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-05-10T07:45:00Z"),
    draftedAt: null,
    updatedAt: new Date("2025-05-10T07:45:00Z"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    ...
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-06-01T12:15:00Z"),
    draftedAt: null,
    updatedAt: new Date("2025-06-01T12:15:00Z"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    ...
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-06-18T09:50:00Z"),
    draftedAt: null,
    updatedAt: new Date("2025-06-18T09:50:00Z"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    ...
    draftedAt: null,
    updatedAt: new Date("2025-07-05T16:00:00Z"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    ...
    draftedAt: null,
    updatedAt: new Date("2025-07-25T08:30:00Z"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    ...
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-08-12T11:20:00Z"),
    draftedAt: null,
    updatedAt: new Date("2025-08-12T11:20:00Z"),
    deletedAt: null,
    isDeleted: false,
  },
];
...
export default function ComponentLevelGridView({
  ...
  const [gridData, setGridData] = useState(noticeData);
  const canDelete: boolean = usePermission("noticeBoards", "delete");
  const canRestore: boolean = usePermission("noticeBoards", "restore");
  const canEdit: boolean = usePermission("noticeBoards", "edit");

  // Debug permissions
  console.log("noticeBoards Permissions:", {
    canDelete,
    canRestore,
    canEdit,
  });
  ...
  const loadMoreData = useCallback(async () => {
    ...
    const newItems = Array.from({ length: ITEMS_PER_PAGE }, (_, index) => ({
      ...
      noticeType: `Notice ${index + 1}`,
      noticeBy: `Notice By ${index + 1}`,
      noticeDate: `Notice Date ${index + 1}`,
  ...
  const filteredData = gridData.filter(
    (item) =>
      item.noticeType.toLowerCase().includes(searchQuery.toLowerCase()) ||
      item.noticeBy.toLowerCase().includes(searchQuery.toLowerCase()) ||
      item.noticeDate.toLowerCase().includes(searchQuery.toLowerCase()) ||
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Total {gridData.length} Notice Lists
        </span>
      </div>
              ...
              >
                ...
                <div className="grid grid-cols-2 items-center gap-2 mb-4">
                  ...
                  <CardTitle
                    ...
                    onClick={() => navigate(`/notice-lists/1`)}
                  >
                    {item.noticeType}
                  </CardTitle>
                      ...
                      <button
                        ...
                        onClick={() => {
                          if (canRestore && item.isDeleted) {
                            ...
                            toastRestore("Notice restored successfully");
                          } else {
                            if (canDelete) {
                              handleDeleteClick(item.id);
                              toastDelete("Notice deleted successfully");
                            }
                          }
                        }}
                      >
                    ...
                    {canEdit && (
                      ...
                      >
                        <div
                          ...
                          onClick={() => navigate(`/notice-lists/edit/1`)}
                        >
          ...
          {isLoading && (
            <div className="flex justify-center items-center py-8">
              <div className="flex items-center gap-2 text-blue-600">
                ...
                <span className="text-sm">Loading more notice lists...</span>
              </div>
            </div>
          )}
