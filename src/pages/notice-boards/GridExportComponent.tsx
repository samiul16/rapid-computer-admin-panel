...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "notice-lists.csv");
  const handleExcel = () => exportToExcel(mockData, "notice-lists.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          title="Notice Lists Details"
          subtitle="Notice Lists Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "notice-lists-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
