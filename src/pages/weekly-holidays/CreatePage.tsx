...
export default function WeeklyHolidayFormPage({ isEdit = false }: Props) {
  ...
  const canView = usePermission("weeklyHolidays", "view");
  const canEdit = usePermission("weeklyHolidays", "edit");
  const canDelete = usePermission("weeklyHolidays", "delete");
  ...
  const endDate: boolean = usePermission("weeklyHolidays", "create", "endDate");
  const totalDays: boolean = usePermission(
    "weeklyHolidays",
    "create",
    "totalDays"
  );
  const isDraft: boolean = usePermission("weeklyHolidays", "create", "isDraft");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (keepCreating) {
      toastSuccess("Weekly holiday created successfully!");
      handleReset();
    } else {
      toastSuccess("Weekly holiday created successfully!");
