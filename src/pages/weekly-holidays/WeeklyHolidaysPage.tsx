...
import EmployeeContractGrid from "./WeeklyHolidaysGrid";
import EmployeeContractDataTable from "./WeeklyHolidaysDataTable";
  ...
  return (
    <div className="w-100vw px-2 py-4 dark:bg-gray-900">
      ...
      <PageHeader
        ...
        createPath="/weekly-holidays/create"
      />
