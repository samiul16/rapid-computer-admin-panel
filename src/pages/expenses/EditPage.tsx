...
export default function ExpensesEditPage({ isEdit = false }: Props) {
  ...
  const isActive: boolean = usePermission("expenses", "create", "isActive");
  const isDeleted: boolean = usePermission("expenses", "create", "isDeleted");
