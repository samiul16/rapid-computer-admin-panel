...
export default function ExpensesGrid({
  ...
  const canRestore: boolean = usePermission("expenses", "restore");
  ...
  const filteredData = gridData.filter(
    (item) =>
      ...
      item.expenseBy.toLowerCase().includes(searchQuery.toLowerCase()) ||
      item.expenseFor.toLowerCase().includes(searchQuery.toLowerCase())
  );
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Total {gridData.length} Expenses
        </span>
      </div>
