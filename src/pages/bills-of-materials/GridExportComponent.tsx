...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "bills-of-materials.csv");
  const handleExcel = () => exportToExcel(mockData, "bills-of-materials.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          subtitle="Bills of Materials Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "bills-of-materials-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
