        ...
        >
          <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 pb-4 p-2">
            {filteredData.map((item, index) => (
              ...
              >
                {/* Top Row - Grid with 2 columns: Document No | Document Date */}
                ...
                {/* Bottom Row - Grid with 3 columns: Invoice No | Actions | Balance */}
                ...
                {/* Additional Row - Debit and Credit */}
                <div className="grid grid-cols-2 items-center gap-4 pt-2 mt-2 border-t dark:border-gray-700">
                  <div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">
                      Debit
                    </div>
