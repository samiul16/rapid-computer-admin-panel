...
import { mockOrderTypeHistoryData } from "@/mockData/order-type-mock-historydata";
...
const MOCK_DATA_SELECT = MOCK_DATA.map((item) => item.typeName);

export default function OrderTypeDetails() {
  ...
  return (
    <>
      <PageLayout
        title={t("button.viewingOrderType")}
        videoSrc={video}
        videoHeader="Rapid ERP Video"
        onListClick={() => navigate("/order-type")}
        listText="List"
        listPath="/order-type"
        popoverOptions={[
          {
            label: "Create",
            onClick: () => navigate("/order-type/create"),
          },
          {
            label: "Edit",
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
          ...
          <div className="md:col-span-3">
            <h3 className="font-medium mb-1">Customer Id</h3>
          ...
          <div className="md:col-span-3">
            <h3 className="font-medium mb-1">Requires Deliveryman</h3>
            <div className="w-full px-1 py-1 text-gray-500 font-normal text-md">
              {viewData.requiresDeliveryman ? "Yes" : "No"}
            </div>
          </div>
        </div>
      ...
      >
        ...
        <Modal.Body>
          <HistoryDataTable columnData={mockOrderTypeHistoryData} />
        </Modal.Body>
      </Modal>
    </>
  );
