    ...
    const columns: ColumnDef<HistoryEntry>[] = [
      {
        ...
        header: ({ column }) => (
          <ColumnFilterHeader column={column} title="Order Type" />
        ),
        cell: (info) => (
      ...
      },
      {
        ...
        header: ({ column }) => (
          <ColumnFilterHeader column={column} title="Customer ID" />
        ),
        cell: (info) => (
      ...
      {
        accessorKey: "requiresDeliveryman",
        header: ({ column }) => (
          <ColumnFilterHeader column={column} title="Requires Deliveryman" />
        ),
        cell: (info) => (
          <div className="text-sm text-gray-900 font-medium">
        ...
        sortingFn: (row1: any, row2: any) => {
          return row1
            .getValue("requiresDeliveryman")
            .localeCompare(row2.getValue("requiresDeliveryman"));
        },
        size: 120,
        minSize: 100,
      },

      {
        ...
        header: ({ column }) => (
          <ColumnFilterHeader column={column} title="Description" />
        ),
        cell: (info) => (
          <div className="text-sm text-gray-900 font-medium">
            {info.getValue() as string}
