...
import { mockSectionsHistoryData } from "@/mockData/sections-history-mockdata";
    ...
    try {
      ...
      const blob = await pdf(
        <PDF
          ...
          subtitle="Section Information Report"
        />
      ).toBlob();
  ...
  return (
    <>
      ...
      >
        ...
        <Modal.Body>
          <HistoryDataTable columnData={mockSectionsHistoryData} />
        </Modal.Body>
      </Modal>
    </>
  );
