...
export const gridCardData: GridCardDataType[] = [
  {
    ...
    code: "KT-MAIN",
    type: "Kitchen",
    description: "Handles all major cooking operations",
    status: "active",
    isDeleted: false,
  },
  {
  ...
  },
  {
    ...
    code: "POS-FRONT",
    type: "POS",
    description: "Primary billing and order section",
    status: "inactive",
    isDeleted: false,
  },
  {
    ...
    code: "BAR-LG",
    type: "Bar",
    description: "Serves beverages and cocktails",
    status: "active",
    isDeleted: false,
  },
  {
    ...
    code: "INV-DRY",
    type: "Inventory",
    description: "Storage for dry goods and supplies",
    status: "active",
    isDeleted: false,
  },
  {
    ...
    code: "INV-COLD",
    type: "Inventory",
    description: "Stores chilled and frozen items",
    status: "draft",
    isDeleted: false,
  },
  {
    ...
    code: "DIN-VIP",
    type: "Dining",
    description: "Exclusive section for VIP guests",
    status: "active",
    isDeleted: false,
  },
  {
    ...
    code: "KT-BAKE",
    type: "Kitchen",
    description: "Section for baking bread and desserts",
    status: "active",
    isDeleted: false,
  },
];
...
export default function ComponentLevelGridTable({
  ...
  const loadMoreData = useCallback(async () => {
    ...
    const newItems = Array.from({ length: ITEMS_PER_PAGE }, (_, index) => ({
      ...
      name: `Section Name#${gridData.length + index + 1}`,
      type: `Type${gridData.length + index + 1}`,
  ...
  return (
    <div className="px-4 py-3 h-full flex flex-col bg-white dark:bg-gray-900 parent">
                  ...
                  <div className="flex items-center justify-center gap-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        ...
                        onClick={() => {
                          ...
                          toastSuccess(
                            item.status === "active"
                              ...
                              : "Section inactivated successfully"
                          );
                        }}
                      >
                        {item.status === "active" ? (
                    ...
                    <Tooltip label="Edit" position="top" withArrow>
                      <div
                        ...
                        onClick={() => navigate(`/sections/edit/1`)}
                      >
      ...
      <Modal
        ...
        title={
          <div className="">
            <h3 className="text-lg font-semibold pl-4">Import Sections</h3>
          </div>
        }
        size="xl"
        overlayProps={{
