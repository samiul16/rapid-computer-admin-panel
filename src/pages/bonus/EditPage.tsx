...
export default function BonusEditPage({ isEdit = false }: Props) {
  ...
  const date: boolean = usePermission("bonus", "edit", "date");
  const iqamaNo: boolean = usePermission("bonus", "edit", "iqamaNo");
  const branch: boolean = usePermission("bonus", "edit", "branch");
  const bonusType: boolean = usePermission("bonus", "edit", "bonusType");
  const bonusAmount: boolean = usePermission("bonus", "edit", "bonusAmount");
  const notes: boolean = usePermission("bonus", "edit", "notes");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toastSuccess("Bonus edited successfully");
  };
