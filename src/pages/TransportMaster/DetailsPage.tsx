...
export default function TransportMasterDetailsPage() {
  ...
  const canCreate: boolean = usePermission("transportMaster", "create");
  const canView: boolean = usePermission("transportMaster", "view");
  ...
  // get permission
  const canCreate2: boolean = usePermission("transportMaster", "create");
  const canEdit2: boolean = usePermission("transportMaster", "edit");
  const canDelete2: boolean = usePermission("transportMaster", "delete");
  const canExport2: boolean = usePermission("transportMaster", "export");
  const canPdf: boolean = usePermission("transportMaster", "pdf");
  const canPrint: boolean = usePermission("transportMaster", "print");
  const canSeeHistory: boolean = usePermission("transportMaster", "history");
  ...
  return (
    <>
      <PageLayout
        ...
        onListClick={() => navigate("/transport-master")}
        listText="List"
        ...
        popoverOptions={[
          {
            ...
            onClick: () => navigate("/transport-master/create"),
          },
          {
            label: "Edit",
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
          <div className="">
            <div className="flex justify-between items-center mb-1">
              <h3 className="font-normal text-gray-600">Transporter Name</h3>
            </div>
