...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "Rental.csv");
  const handleExcel = () => exportToExcel(mockData, "Rental.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          subtitle="Rental Information Report"
        />
      ).toBlob();
