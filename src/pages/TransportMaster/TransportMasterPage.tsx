...
import TransportMasterGrid from "./TransportMasterGrid";
import TransportMasterDataTable2 from "./TransportMasterDataTable2";
  ...
  return (
    <div className="w-100vw px-2 py-4 dark:bg-gray-900">
      ...
      <PageHeader
        ...
        createPath="/transport-master/create"
      />
