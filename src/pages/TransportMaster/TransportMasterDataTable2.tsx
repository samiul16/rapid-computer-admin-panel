...
const mockHoliday = [
  ...
  {
    id: 2,
    transporterName: "Bangla Cargo Services",
  ...
  {
    id: 3,
    transporterName: "Dhaka Freight Movers",
  ...
  {
    id: 4,
    transporterName: "Chittagong Port Logistics",
  ...
  {
    id: 5,
    transporterName: "Sylhet Parcel Express",
  ...
  {
    id: 6,
    transporterName: "Rajshahi Transport Co.",
  ...
  {
    id: 7,
    transporterName: "Khulna Cargo Movers",
  ...
  {
    id: 8,
    transporterName: "Barisal River Transport",
  ...
  {
    id: 9,
    transporterName: "Mymensingh Logistics Ltd.",
  ...
  {
    id: 10,
    transporterName: "Gazipur Industrial Transport",
  ...
  {
    id: 11,
    transporterName: "Rangpur Parcel Line",
  ...
  {
    id: 12,
    transporterName: "Comilla Transport Agency",
...
export default function TransportMasterDataTable2({
  viewMode,
  setViewMode,
  dataTableFilter,
  searchQuery,
  ...
  const componentColumns = [
    {
      ...
      options: [...new Set(mockHoliday.map((item) => item.transporterName))],
  ...
  return (
    <FixedColumnDataTable
      ...
      fixedColumns={["transporterName", "status"]} // Pin name column
      pathName="transport-master"
