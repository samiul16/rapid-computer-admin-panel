...
export default function TransportMasterFormPage({ isEdit = false }: Props) {
  ...
  const name: boolean = usePermission("transportMaster", "create", "name");
                ...
                <div className="md:col-span-3 space-y-2">
                  <div className="relative">
                    <EditableInput
                      ...
                      onCancel={() => setFormData({ ...formData, code: "COD-571" })}
