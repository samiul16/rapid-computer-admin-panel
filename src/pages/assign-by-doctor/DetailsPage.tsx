...
export default function DoctorDetails() {
  ...
  // Get appointment data based on selected appointment
  const getAppointmentData = (appointmentId: string): DetailsPageTypes => {
    ...
    return appointmentMap[appointmentId] || initialData;
  };

  const [appointmentData, setAppointmentData] = useState<DetailsPageTypes>(
    getAppointmentData(selectedAppointment)
  );
  ...
  useEffect(() => {
    setAppointmentData(getAppointmentData(selectedAppointment));
  }, [selectedAppointment]);
    ...
    <>
      ...
      >
        <div dir={isRTL ? "rtl" : "ltr"}>
          {/* Row 1: Appointment Selection, Appointment Details */}
