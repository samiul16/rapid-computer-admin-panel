...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "allowances.csv");
  const handleExcel = () => exportToExcel(mockData, "allowances.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          subtitle="Allowance Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "allowances-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
