...
export default function AllowancesEditPage({ isEdit = false }: Props) {
  ...
  const [isActiveState, setIsActiveState] = useState<"Yes" | "No">("No");
  ...
  const isActive: boolean = usePermission("allowances", "create", "isActive");
  const isDeleted: boolean = usePermission("allowances", "create", "isDeleted");
        ...
        return [
          ...filteredOptions,
          {
            ...
            onClick: () => {
              ...
              toastRestore("Allowance saved as draft successfully");
            },
