...
export default function JobCategoriesEditPage({ isEdit = false }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (printEnabled) {
      handlePrintJobCategories(formData);
    }
    if (keepCreating) {
      handleReset();
    ...
    toastSuccess("JobCategories Edited successfully");
  };
  ...
  const handlePrintJobCategories = (MockData: any) => {
    try {
      const html = PrintCommonLayout({
        title: "JobCategories Details",
        data: [MockData],
    ...
    try {
      ...
      const blob = await pdf(
        <GenericPDF
          data={[formData]}
          title="JobCategories Details"
          subtitle="JobCategories Information"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "JobCategories-details.pdf";
      a.click();
        ...
        return [
          ...filteredOptions,
          {
            ...
            onClick: () => {
              ...
              toastRestore("JobCategories saved as draft successfully");
            },
          },
        ];
      }
