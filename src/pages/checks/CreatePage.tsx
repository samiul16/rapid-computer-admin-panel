...
export default function ChecksFormPage({ isEdit = false }: Props) {
  ...
  const permissionsFields = usePermission<keyof CheckData>("checks", "create", [
    "vendorName",
    "date",
    "bankAccount",
    "amount",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (keepCreating) {
      toastSuccess("Check record created successfully!");
      handleReset();
    } else {
      toastSuccess("Check record created successfully!");
      navigate("/checks");
