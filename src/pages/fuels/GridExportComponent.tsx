...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "fuels.csv");
  const handleExcel = () => exportToExcel(mockData, "fuels.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          title="Fuel Details"
          subtitle="Fuel Information Report"
        />
      ).toBlob();
