...
type ProjectTypeDataType = ModuleFieldsType & {
  isDefault: boolean;
  isDraft: boolean;
...
export const initialData: ModuleFieldsType = {
  campaignCode: "",
  campaignName: "",
  recruitmentPlan: "",
  recruitmentChannel: "",
...
const initialDataWithValue: ProjectTypeDataType = {
...
// Utility to extract the keys of ProjectTypeDataType whose values are strings
...
type FieldConfig = {
  name: StringKeys<ProjectTypeDataType>;
  label: string;
...
export const formFields: FieldConfig[] = [
  ...
  },
  {
    ...
    label: "Company",
    component: "input",
    nextFocus: "recruitedQuantity",
    tooltip: "Enter company name",
    required: true,
  },
  {
    name: "recruitedQuantity",
    label: "Recruited Quantity",
    component: "input",
    nextFocus: "workingFrom",
    tooltip: "Enter recruited quantity",
    required: true,
  },
  {
    name: "workingFrom",
    ...
    tooltip: "Enter working from date",
    required: true,
  },
  {
    name: "department",
  ...
  },
  {
    ...
    options: ["Manager 1", "Manager 2", "Manager 3", "Manager 4", "Manager 5"],
    placeholder: " ",
    nextFocus: "followers",
    tooltip: "Select managers",
  },
  {
    name: "followers",
    label: "Followers",
  ...
  },
  {
    ...
    label: "Meta Title",
    component: "input",
    nextFocus: "metaDescription",
    tooltip: "Enter meta title",
    required: true,
  },
  {
    ...
    component: "input",
    nextFocus: "ageFrom",
    tooltip: "Enter meta description",
    required: true,
  },
...
export default function CampaignsEditPage({ isEdit = false }: Props) {
  ...
  useEffect(() => {
    if (isEdit && initialDataWithValue) {
      ...
      setImagePreview(initialDataWithValue.attachment);
