...
type ModuleCreateEditPageTypes = ModuleFieldsType & {
  isDefault: boolean;
  isDraft: boolean;
...
// Utility to extract the keys of ModuleCreateEditPageTypes whose values are strings
...
// field types
type FieldConfig = {
  name: StringKeys<ModuleCreateEditPageTypes>;
  label: string;
...
// chnage here add your property name here
...
export default function CampaignsCreatePage({ isEdit = false }: Props) {
