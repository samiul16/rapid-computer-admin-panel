...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "wake-up-calls.csv");
  const handleExcel = () => exportToExcel(mockData, "wake-up-calls.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          subtitle="Wake Up Calls Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "wake-up-calls-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
