...
export default function WakeUpCallsCreatePage({ isEdit = false }: Props) {
  ...
  const permissionsFieldLevel = usePermission<keyof ProjectTypeDataType>(
    "wakeUpCalls",
    "create",
    ["customerName", "dateAndTime", "description", "isDefault", "isDraft"]
  );
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (keepCreating) {
      toastSuccess("Wake Up Call created successfully!");
      handleReset();
    } else {
      toastSuccess("Wake Up Call created successfully!");
