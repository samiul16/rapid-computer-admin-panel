...
const wakeUpCallsData: GridDataType[] = [
  {
    id: "1",
    ...
    draftedAt: null,
    updatedAt: new Date("2025-08-20T11:00:00"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    ...
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-08-19T14:45:00"),
    draftedAt: null,
    updatedAt: new Date("2025-08-19T15:10:00"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    ...
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-08-18T09:10:00"),
    draftedAt: null,
    updatedAt: new Date("2025-08-18T09:30:00"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    ...
    isActive: false,
    isDraft: true,
    createdAt: new Date("2025-08-17T17:20:00"),
    draftedAt: new Date("2025-08-17T17:25:00"),
    updatedAt: new Date("2025-08-17T17:25:00"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    ...
    isActive: false,
    isDraft: false,
    createdAt: new Date("2025-08-16T11:05:00"),
    draftedAt: null,
    updatedAt: new Date("2025-08-16T11:30:00"),
    deletedAt: new Date("2025-08-16T11:45:00"),
    isDeleted: true,
  },
  {
    id: "6",
    ...
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-08-15T16:15:00"),
    draftedAt: null,
    updatedAt: new Date("2025-08-15T16:20:00"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    ...
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-08-14T20:40:00"),
    draftedAt: null,
    updatedAt: new Date("2025-08-14T20:42:00"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    ...
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-08-13T18:55:00"),
    draftedAt: null,
    updatedAt: new Date("2025-08-13T19:05:00"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    ...
    isActive: false,
    isDraft: false,
    createdAt: new Date("2025-08-12T13:25:00"),
    draftedAt: null,
    updatedAt: new Date("2025-08-12T13:30:00"),
    deletedAt: new Date("2025-08-12T13:35:00"),
    isDeleted: true,
  },
  {
    id: "10",
    ...
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-08-11T07:15:00"),
    draftedAt: null,
    updatedAt: new Date("2025-08-11T07:20:00"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    ...
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-08-10T09:50:00"),
    draftedAt: null,
    updatedAt: new Date("2025-08-10T09:55:00"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    ...
    isActive: false,
    isDraft: false,
    createdAt: new Date("2025-08-09T15:35:00"),
    draftedAt: null,
    updatedAt: new Date("2025-08-09T15:45:00"),
    deletedAt: new Date("2025-08-09T15:50:00"),
    isDeleted: true,
  },
];
...
export default function ComponentLevelGridView({
  ...
  const [gridData, setGridData] = useState(wakeUpCallsData);
  const canDelete: boolean = usePermission("wakeUpCalls", "delete");
  const canRestore: boolean = usePermission("wakeUpCalls", "restore");
  const canEdit: boolean = usePermission("wakeUpCalls", "edit");

  // Debug permissions
  console.log("wakeUpCalls Permissions:", {
    canDelete,
    canRestore,
    canEdit,
  });
  ...
  const filteredData = gridData.filter(
    (item) =>
      ...
      item.dateAndTime.toLowerCase().includes(searchQuery.toLowerCase()) ||
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Total {gridData.length} Wake Up Calls
        </span>
      </div>
              ...
              >
                ...
                <div className="grid grid-cols-2 items-center gap-2 mb-4">
                  ...
                  <CardTitle
                    ...
                    onClick={() => navigate(`/wake-up-calls/1`)}
                  >
                    {item.customerName}
                  </CardTitle>
                </div>
                      ...
                      <button
                        ...
                        onClick={() => {
                          if (canRestore && item.isDeleted) {
                            ...
                            toastRestore("Wake Up Call restored successfully");
                          } else {
                            if (canDelete) {
                              handleDeleteClick(item.id);
                              toastDelete("Wake Up Call deleted successfully");
                            }
                          }
                        }}
                      >
                    ...
                    {canEdit && (
                      ...
                      >
                        <div
                          ...
                          onClick={() => navigate(`/wake-up-calls/edit/1`)}
                        >
          ...
          {isLoading && (
            <div className="flex justify-center items-center py-8">
              <div className="flex items-center gap-2 text-blue-600">
                ...
                <span className="text-sm">Loading more wake up calls...</span>
              </div>
            </div>
          )}
