...
import ReceiveWarehouseLogisticDataTable from "./DataTable";
import ReceiveWarehouseLogisticGrid from "./Grid";
...
export default function ReceiveWarehouseLogisticsPage() {
  ...
  return (
    <div className="w-100vw px-2 py-4 dark:bg-gray-900">
      ...
      <PageHeader
        ...
        title="Receive Warehouse Logistic"
        createPath="/receive-warehouse-logistics/create"
      />
      ...
      {viewMode === "grid" ? (
        ...
        <div className="mt-4 h-[calc(100vh-322px)] overflow-y-auto overflow-x-hidden border rounded-lg scroll-smooth [scrollbar-gutter:stable]">
          <ReceiveWarehouseLogisticDataTable
            viewMode={viewMode}
            searchQuery={searchQuery}
            setViewMode={setViewMode}
            dataTableFilter={dataTableFilter}
