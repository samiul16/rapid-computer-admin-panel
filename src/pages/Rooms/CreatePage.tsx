...
export default function RoomsCreatePage({ isEdit = false }: Props) {
  ...
  // const name: boolean = usePermission("rooms", "create", "name");

  const isDefault: boolean = usePermission("rooms", "create", "isDefault");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (keepCreating) {
      toastSuccess("Rooms created successfully!");
      handleReset();
    } else {
      toastSuccess("Rooms created successfully!");
      navigate("/rooms");
        ...
        return [
          ...filteredOptions,
          {
            ...
            onClick: () => {
              ...
              toastRestore("Rooms saved as draft successfully");
            },
