...
export default function RoomsDetailsPage() {
  ...
  const canCreate: boolean = usePermission("rooms", "create");
  const canView: boolean = usePermission("rooms", "view");
  const canPrint: boolean = usePermission("rooms", "print");
  const canSeeHistory: boolean = usePermission("rooms", "history");
  ...
  const handleSwitchChange = (checked: boolean) => {
    ...
    // if (checked) {
    //   setTimeout(() => handlePrintRoomSize(RoomsData), 100);
    // }
  };
  ...
  const handleExportPDF = async () => {
    ...
    try {
      console.log("RoomsData on pdf click", RoomsData);
  ...
  return (
    <>
      <PageLayout
        title={t("button.viewingRooms")}
        videoSrc={video}
        videoHeader="Tutorial video"
        onListClick={() => navigate("/rooms")}
        listText="List"
        listPath="rooms"
        activePage="view"
        popoverOptions={[
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
          <div className="">
            ...
            <div className="w-full py-1 text-gray-900 font-bold text-md dark:text-white">
              {displayValue(RoomsData.roomType)}
            </div>
          </div>
          ...
          <div className="">
            ...
            <div className="w-full py-1 text-gray-900 font-bold text-md dark:text-white">
              {displayValue(RoomsData.roomSize)}
            </div>
          </div>
          ...
          <div className="">
            ...
            <div className="w-full py-1 text-gray-900 font-bold text-md dark:text-white">
              {displayValue(RoomsData.rate)}
            </div>
          </div>

          <div className="">
            <h3 className="font-normal mb-1 text-gray-600">Capacity</h3>
            <div className="w-full py-1 text-gray-900 font-bold text-md dark:text-white">
              {displayValue(RoomsData.capacity)}
            </div>
          </div>

          <div className="">
            <h3 className="font-normal mb-1 text-gray-600">Extra Capacity</h3>
            <div className="w-full py-1 text-gray-900 font-bold text-md dark:text-white">
              {displayValue(RoomsData.extraCapacity)}
            </div>
          </div>
          ...
          <div className="">
            ...
            <div className="w-full py-1 text-gray-900 font-bold text-md dark:text-white">
              {displayValue(RoomsData.description)}
            </div>
          </div>
      ...
      <HistoryDataTable
        ...
        title="History"
        statusInfo={{
          created: getRelativeTime(RoomsData.createdAt),
          updated: getRelativeTime(RoomsData.updatedAt),
          drafted: getRelativeTime(RoomsData.draftedAt),
          deleted: getRelativeTime(RoomsData.deletedAt),
        }}
      />
