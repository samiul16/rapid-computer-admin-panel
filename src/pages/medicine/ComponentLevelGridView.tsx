...
export const plansData: GridDataType[] = [
  ...
  },
  {
    ...
    price: "180.00",
    manufacturedBy: "Drug International Ltd.",
    status: "Low Stock",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    categoryName: "Vitamin & Mineral",
    description: "Bone health supplement for vitamin D deficiency",
    price: "65.00",
    manufacturedBy: "Healthcare Pharmaceuticals Ltd.",
    status: "Available",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    categoryName: "Analgesic",
    description: "Anti-inflammatory pain reliever for moderate pain",
    price: "55.00",
    manufacturedBy: "General Pharmaceuticals Ltd.",
    status: "Available",
    isDefault: false,
    isActive: true,
    isDraft: false,
        ...
        >
          <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 pb-4 p-2">
            {filteredData.map((item, index) => (
              ...
              >
                {/* Top Row - Grid with 2 columns: Medicine Name | Price */}
                ...
                {/* Bottom Row - Grid with 3 columns: Category | Actions | Status */}
                ...
                {/* Additional Row - Manufactured By */}
                <div className="grid grid-cols-1 items-center gap-4 pt-2 mt-2 border-t dark:border-gray-700">
                  <div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">
                      Manufactured By
                    </div>
