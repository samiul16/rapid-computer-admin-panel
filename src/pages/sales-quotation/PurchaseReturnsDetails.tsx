...
const MOCK_ORDERS = [
  {
    purchaseInvoiceNumber: "ORD001",
    supplierName: "AL AHAD CURTAINS TEX & FURNITURE TR.LLC",
  },
  { purchaseInvoiceNumber: "ORD002", supplierName: "SimplyNayela" },
  {
    purchaseInvoiceNumber: "ORD003",
    supplierName: "BROWN HUT AUTO ACCESSORISE TR L.L.C",
  },
  {
    purchaseInvoiceNumber: "ORD004",
    supplierName: "PIDILITE MEA CHEMICALS L.L.C",
  },
  {
    purchaseInvoiceNumber: "ORD005",
    supplierName: "TOP LEATHER Vehicles Upholstery Service L.L.C",
  },
  {
    purchaseInvoiceNumber: "ORD006",
    supplierName: "AL WESAL AUTO ACCESSORIES LLC",
  },
];
...
const ORDER_DOCUMENT_NUMBERS = MOCK_ORDERS.map(
  (order) => order.purchaseInvoiceNumber
);
...
const MOCK_INVENTORY_ITEMS: InventoryItem[] = [
  {
    purchaseInvoiceNumber: "SN001",
    documentNumber: "ORD001",
    poNumber: "PO001",
    dueDays: "45",
    supplierName: "Office Chairs - Executive",
  },
  {
    purchaseInvoiceNumber: "SN002",
    documentNumber: "ORD002",
    poNumber: "PO002",
    dueDays: "45",
    supplierName: "Laptop Computers - Dell",
  },
  {
    purchaseInvoiceNumber: "SN003",
    documentNumber: "ORD003",
    poNumber: "PO003",
    dueDays: "45",
    supplierName: "Printer Paper - A4 Reams",
  },
];
...
export default function PurchaseReturnsDetails() {
  ...
  const orderData: Order = {
    ...
    poDate: "2024-07-24",
    supplierName:
      MOCK_ORDERS.find((o) => o.purchaseInvoiceNumber === selectedOrder)
        ?.supplierName || "AL AHAD CURTAINS TEX & FURNITURE TR.LLC",
    paymentMode: "Split",
    dueDays: 45,
  ...
  const handlePrintOrder = (orderData: Order) => {
    try {
      const html = PrintCommonLayout({
        title: "Purchase Returns Details",
    ...
    try {
      ...
      const blob = await pdf(
        <GenericPDF
          data={[orderData]}
          title="Purchase Returns Details"
          subtitle="Purchase Returns Information"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "purchase-returns-details.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
      ...
      <div className="flex flex-col h-[82vh] overflow-hidden border rounded shadow bg-white dark:bg-gray-800 ">
        ...
        <div className="sticky top-0 bg-white dark:bg-gray-800 border-b px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-bold text-primary">
              {t("form.viewingPurchaseReturn")}
            </h1>
          </div>
          <div className="flex items-center gap-2">
            <div className="flex items-center">
              <SplitButton
                onListClick={() => navigate("/purchase-returns")}
                listText="List"
                ...
                popoverOptions={[
                  ...
                  {
                    label: "Edit",
                    onClick: () => navigate("/purchase-returns/1/edit"),
                  },
                ]}
              />
            </div>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="space-y-2">
              <h3 className="font-medium mb-1">
                Purchase Invoice Number <span className="text-red-500">*</span>
              </h3>
              <Autocomplete
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="space-y-2">
              <h3 className="font-medium mb-1">Documents Name</h3>
              <div className="w-full py-2 text-gray-500 font-normal text-md min-h-[40px] flex items-center">
                {orderData.documents}
              </div>
            </div>
          ...
          <div className="flex flex-col items-center justify-center">
            <h3 className="font-medium mb-2 text-center">Documents Images</h3>
