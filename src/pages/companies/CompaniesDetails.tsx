...
const MOCK_COMPANIES = [
  { code: "C001", name: "TechCorp Solutions" },
  { code: "C002", name: "Global Industries" },
  { code: "C003", name: "InnovateTech" },
  { code: "C004", name: "BlueSky Enterprises" },
  { code: "C005", name: "NextGen Solutions" },
  { code: "C006", name: "Digital Dynamics" },
];
...
const COMPANY_CODES = MOCK_COMPANIES.map((company) => company.code);
...
export default function CompaniesDetails() {
  ...
  const companyData: Company = {
    ...
    name:
      MOCK_COMPANIES.find((c) => c.code === selectedCompany)?.name ||
      "TechCorp Solutions",
  ...
  const handleSwitchChange = (checked: boolean) => {
    ...
    if (checked) {
      setTimeout(() => handlePrintCompany(companyData), 100);
    }
  };
  ...
  const handleExportPDF = async () => {
    ...
    try {
      console.log("companyData on pdf click", companyData);
  ...
  const handleDeleteRestore = () =>
    console.log(companyData.isDeleted ? "Restoring..." : "Deleting...");
    ...
    <div className="relative w-full">
      ...
      <div className="flex flex-col h-[82vh] overflow-hidden border rounded shadow bg-white dark:bg-gray-800 ">
        ...
        <div className="sticky top-0 bg-white dark:bg-gray-800 border-b px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-bold text-primary">
              {t("form.viewingCompany")}
            </h1>
          </div>
          <div className="flex items-center gap-2">
            <div className="flex items-center">
              <SplitButton
                onListClick={() => navigate("/companies")}
                listText="List"
                listPath="/companies"
                popoverOptions={[
                  {
                  ...
                  {
                    label: "Edit",
                    onClick: () => navigate("/companies/1/edit"),
                  },
                ]}
              />
            </div>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
          {/* Row 1: Code, Company Name, Tax Number */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            <div className="">
              <div className="flex justify-between items-center mb-1">
                <h3 className="font-medium">{t("form.currency")}</h3>
              </div>
              <div className="w-full py-1 text-gray-500 font-normal text-md">
            ...
            <div className="">
              <div className="flex justify-between items-center mb-1">
                <h3 className="font-medium">{t("form.timezone")}</h3>
              </div>
              <div className="w-full py-1 text-gray-500 font-normal text-md">
            ...
            <div className="">
              <div className="flex justify-between items-center mb-1">
                <h3 className="font-medium">{t("form.dateFormat")}</h3>
              </div>
              <div className="w-full py-1 text-gray-500 font-normal text-md">
                {companyData.dateFormat}
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="">
              ...
              <Button
                ...
                disabled={companyData.isDeleted}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="">
              ...
              <p className="text-gray-500 text-md font-normal">
                {getRelativeTime(companyData.createdAt)}
              </p>
            </div>
            <div className="">
              <h3 className="font-medium mb-1">Updated</h3>
              <p className="text-gray-500 text-md font-normal">
                {getRelativeTime(companyData.updatedAt)}
              </p>
            </div>
            <div className="">
              <h3 className="font-medium mb-1">Drafted</h3>
              <p className="text-gray-500 text-md font-normal">
                {getRelativeTime(companyData.draftedAt)}
              </p>
            </div>
            <div className="">
              <h3 className="font-medium mb-1">Deleted</h3>
              <p className="text-gray-500 text-md font-normal">
                {getRelativeTime(companyData.deletedAt)}
              </p>
            </div>
          </div>
