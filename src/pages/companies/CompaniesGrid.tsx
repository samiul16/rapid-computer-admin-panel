...
// Define Company interface to ensure type consistency
interface Company {
  id: string;
  code: string;
  name: string;
...
const companies: Company[] = [
  ...
  },
  {
    ...
    favicon: "https://globalinnovations.com/favicon.ico",
  ...
  },
  {
    ...
    favicon: "https://tokyodigital.jp/favicon.ico",
  ...
  },
  {
    ...
    dateFormat: "DD.MM.YYYY",
    favicon: "https://municheng.de/favicon.ico",
  ...
  },
  {
    ...
    dateFormat: "DD/MM/YYYY",
    favicon: "https://parisfashion.fr/favicon.ico",
  ...
  },
  {
    ...
    dateFormat: "DD/MM/YYYY",
    favicon: "https://milanodesign.it/favicon.ico",
  ...
  },
  {
    ...
    dateFormat: "DD/MM/YYYY",
    favicon: "https://madridmarketing.es/favicon.ico",
  ...
  },
  {
    ...
    dateFormat: "DD-MM-YYYY",
    favicon: "https://portotech.pt/favicon.ico",
  ...
  },
  {
    ...
    dateFormat: "DD.MM.YYYY",
    favicon: "https://zurichfinancial.ch/favicon.ico",
  ...
  },
  {
    ...
    dateFormat: "DD-MM-YYYY",
    favicon: "https://amsterdamtrade.nl/favicon.ico",
  ...
  },
  {
    id: "11",
    code: "C011",
    name: "Brussels Consulting Group",
    taxNumber: "BE123456789",
    phone: "+32-2-1234567",
    fax: "+32-2-1234568",
    mobile: "+32-4-12345678",
    email: "contact@brusselsconsulting.be",
    ...
    dateFormat: "DD/MM/YYYY",
    favicon: "https://brusselsconsulting.be/favicon.ico",
  ...
  },
  {
    id: "12",
    code: "C012",
    name: "European Holdings Ltd",
    taxNumber: "BE987654321",
    phone: "+32-2-9876543",
    fax: "+32-2-9876544",
    mobile: "+32-4-98765432",
    email: "info@europeanholdings.be",
    ...
    dateFormat: "DD/MM/YYYY",
    favicon: "https://europeanholdings.be/favicon.ico",
  ...
  },
  {
    id: "13",
    code: "C013",
    name: "Brussels Tech Hub",
    taxNumber: "BE555666777",
    phone: "+32-2-5556667",
    fax: "+32-2-5556668",
    mobile: "+32-4-55566677",
    email: "hello@brusselstechhub.be",
    ...
    dateFormat: "DD/MM/YYYY",
    favicon: "https://brusselstechhub.be/favicon.ico",
  ...
  },
  {
    id: "14",
    code: "C014",
    name: "London Financial Partners",
    taxNumber: "GB123456789",
    phone: "+44-20-12345678",
    fax: "+44-20-12345679",
    mobile: "+44-7700-123456",
    email: "info@londonfinancial.co.uk",
    ...
    dateFormat: "DD/MM/YYYY",
    favicon: "https://londonfinancial.co.uk/favicon.ico",
  ...
  },
  {
    ...
    email: "contact@globalmarketing.be",
    ...
    dateFormat: "DD/MM/YYYY",
    favicon: "https://globalmarketing.be/favicon.ico",
  ...
  },
  {
    ...
    email: "labs@digitalinnovation.be",
    ...
    dateFormat: "DD/MM/YYYY",
    favicon: "https://digitalinnovation.be/favicon.ico",
...
export default function CompaniesGrid({
  ...
  console.log("Companies grid rendered");
  ...
  const loadMoreData = useCallback(async () => {
    ...
    const companyTypes = ["Corp", "Inc", "Ltd", "GmbH", "SA", "BV"];

    const newItems = Array.from({ length: ITEMS_PER_PAGE }, (_, index) => {
      const randomIndex = Math.floor(Math.random() * countries.length);
      return {
        id: `${Date.now()}-${index}`,
        code: `C${(companiesData.length + index + 1)
          .toString()
          .padStart(3, "0")}`,
        name: `${
          companyTypes[Math.floor(Math.random() * companyTypes.length)]
        } Company ${companiesData.length + index + 1}`,
        ...
        email: `contact@company${companiesData.length + index + 1}.com`,
        website: `https://company${companiesData.length + index + 1}.com`,
        ...
        bankDetails: `Bank Details ${companiesData.length + index + 1}`,
        dateFormat: "MM/DD/YYYY",
        favicon: `https://company${
          companiesData.length + index + 1
        }.com/favicon.ico`,
    ...
    if (companiesData.length >= 46) {
      setHasMore(false);
    } else {
      setCompaniesData((prev) => [...prev, ...newItems]);
      setPage((prev) => prev + 1);
    }

    setIsLoading(false);
  }, [companiesData.length, isLoading, hasMore]);
      ...
      prevCompanies.map((company) =>
        company.id === companyId
          ? {
              ...
              deletedAt: !company.isDeleted ? new Date() : null,
            }
          : company
      )
    );
  ...
  const handleRestoreClick = (companyId: string) => {
    setCompaniesData((prevCompanies) =>
      prevCompanies.map((company) =>
        company.id === companyId
          ? {
    ...
    <div className="px-4 py-3 h-full flex flex-col bg-white dark:bg-gray-900 parent">
      ...
      <div className="flex flex-1 overflow-hidden mt-2">
        ...
        >
              ...
              >
                ...
                <div className="grid grid-cols-3 items-center gap-4 mb-4">
                  ...
                  <div className="min-w-0">
                    <Tooltip label={company.name} position="top" withArrow>
                      <CardTitle
                  ...
                  <div className="flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    ...
                    >
                      <div
                        className={`cursor-pointer p-1 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors flex items-center justify-center ${
                          company.isActive ? "text-green-500" : "text-gray-400"
                        }`}
                        onClick={() => {
                    ...
                    {/* Delete/Restore */}
                    <Tooltip
                      label={company.isDeleted ? "Restore" : "Delete"}
                      position="top"
                      withArrow
                    >
                      <div
                        className={`cursor-pointer p-1 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors flex items-center justify-center ${
                          company.isDeleted ? "text-blue-500" : "text-red-500"
                        }`}
                        onClick={() => {
                          if (company.isDeleted) {
                            handleRestoreClick(company.id);
                          } else {
                    ...
                    <div className="w-10 h-10 rounded-full overflow-hidden border border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-600 flex items-center justify-center">
                      <img
                        ...
                        onError={(e) => {
                          ...
                          // Fallback to initials with company code colors
                          const colors = [
                            "FF6B6B",
                            "4ECDC4",
                            "45B7D1",
                          ...
                          const colorIndex =
                            company.code.charCodeAt(company.code.length - 1) %
                            colors.length;
          ...
          {!hasMore && filteredCompanies.length > 12 && (
            <div className="flex justify-center items-center py-8">
        ...
        {isFilterOpen && (
          <div className="w-80 flex-shrink-0 border-l border-gray-200 dark:border-gray-700 pl-4">
            <div className="h-full flex flex-col">
              <GridFilterComponent
                data={companies}
                setFilteredData={setCompaniesData}
      ...
      <Modal
        ...
        title={
          <div className="">
            <h3 className="text-lg font-semibold pl-4 ">Import Company</h3>
          </div>
        }
        size="xl"
        overlayProps={{
