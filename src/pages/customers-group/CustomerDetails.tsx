...
export default function CustomerDetails() {
  ...
  return (
    <>
      <PageLayout
        title={t("form.viewingCustomerGroup")}
        videoSrc={video}
        videoHeader="Rapid ERP Video"
        onListClick={() => navigate("/customer-group")}
        listText="List"
        ...
        popoverOptions={[
          ...
          {
            label: "Edit",
            onClick: () => navigate("/customer-group/edit/1"),
          },
        ]}
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
          ...
          <div className="md:col-span-3">
            <h3 className="font-medium mb-1">Customer Group Name</h3>
            <div className="w-full px-1 py-1 text-gray-500 font-normal text-md">
              {customerData.customerGroupName}
            </div>
          </div>
          <div className="md:col-span-3">
