...
export default function ShipmentDetails() {
  ...
  // get permission
  const canCreate: boolean = usePermission("shipment", "create");
  const canView: boolean = usePermission("shipment", "view");
  const canEdit: boolean = usePermission("shipment", "edit");
  const canDelete: boolean = usePermission("shipment", "delete");
  const canExport: boolean = usePermission("shipment", "export");
  const canPdf: boolean = usePermission("shipment", "pdf");
  const canPrint: boolean = usePermission("shipment", "print");
  const canSeeHistory: boolean = usePermission("shipment", "history");

  // // Field-level permissions
  // const branch: boolean = usePermission("shipment", "view", "branch");
  ...
  // const category: boolean = usePermission("shipment", "view", "category");

  // const subCategory: boolean = usePermission("shipment", "view", "subCategory");

  // const expense: boolean = usePermission("shipment", "view", "expense");

  // const date: boolean = usePermission("shipment", "view", "date");
  // const amount: boolean = usePermission("shipment", "view", "amount");
  // const currency: boolean = usePermission("shipment", "view", "currency");
  // const paymentMode: boolean = usePermission("shipment", "view", "paymentMode");
  // const vat: boolean = usePermission("shipment", "view", "vat");
  // const supplier: boolean = usePermission("shipment", "view", "supplier");
  // const approvedBy: boolean = usePermission("shipment", "view", "approvedBy");
  ...
  //   "supplierVatNumber"
  // );
  // const expenseBy: boolean = usePermission("shipment", "view", "expenseBy");
  // const expenseFor: boolean = usePermission("shipment", "view", "expenseFor");
  // const note: boolean = usePermission("shipment", "view", "note");
