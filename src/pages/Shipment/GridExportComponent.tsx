...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "expenses.csv");
  const handleExcel = () => exportToExcel(mockData, "expenses.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          subtitle="Expenses Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "expenses-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
