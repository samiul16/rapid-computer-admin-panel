...
export const gridCardData: GridCardDataType[] = [
  ...
  },
  {
    ...
    name: "Kitchen Staff",
    code: "KITCHEN",
    description: "Handles food preparation and kitchen operations",
    status: "active",
    isDeleted: false,
  },
  {
    ...
    name: "Waiters",
    code: "WAITER",
    description: "Responsible for taking and serving orders",
    status: "inactive",
    isDeleted: false,
  },
  {
    ...
    name: "Cashiers",
    code: "CASHIER",
    description: "Manages customer billing and payments",
    status: "active",
    isDeleted: false,
  },
  {
    ...
    name: "Inventory Team",
    code: "INVENTORY",
    description: "Controls stock and warehouse items",
    status: "draft",
    isDeleted: false,
  },
  {
    ...
    name: "Delivery Team",
    code: "DELIVERY",
    description: "Responsible for delivering food to customers",
    status: "active",
    isDeleted: false,
  },
  {
    ...
    name: "Marketing Team",
    code: "MKT",
    description: "Handles all restaurant promotions and campaigns",
    status: "inactive",
    isDeleted: false,
  },
  {
    ...
    code: "QA",
    description: "Ensures food quality and hygiene standards",
    status: "active",
    isDeleted: false,
  },
];
...
export default function ComponentLevelGridTable({
  ...
  const loadMoreData = useCallback(async () => {
    ...
    const newItems = Array.from({ length: ITEMS_PER_PAGE }, (_, index) => ({
      ...
      name: `Group Name#${gridData.length + index + 1}`,
  ...
  return (
    <div className="px-4 py-3 h-full flex flex-col bg-white dark:bg-gray-900 parent">
                  ...
                  <div className="flex items-center justify-center gap-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    ...
                    <Tooltip label="Edit" position="top" withArrow>
                      <div
                        ...
                        onClick={() => navigate(`/groups/edit/1`)}
                      >
      ...
      <Modal
        ...
        title={
          <div className="">
            <h3 className="text-lg font-semibold pl-4">Import Groups</h3>
          </div>
        }
        size="xl"
        overlayProps={{
