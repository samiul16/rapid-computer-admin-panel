...
import { mockGroupHistoryData } from "@/mockData/group-history-mockdata";
...
export default function GroupsDetails() {
  ...
  const [initialSelectedValue, setInitialSelectedValue] = useState("ADMIN");
    ...
    try {
      ...
      const blob = await pdf(
        <PDF
          data={[viewData]}
          title="Group Details"
          subtitle="Group Information Report"
        />
      ).toBlob();
  ...
  return (
    <>
      <PageLayout
        title={t("button.viewingGroup")}
        videoSrc={video}
        videoHeader="Rapid ERP Video"
        onListClick={() => navigate("/groups")}
        listText="List"
        listPath="/groups"
        popoverOptions={[
          {
      ...
      >
        ...
        <Modal.Body>
          <HistoryDataTable columnData={mockGroupHistoryData} />
        </Modal.Body>
      </Modal>
    </>
  );
