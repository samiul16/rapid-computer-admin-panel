...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "task-assigns.csv");
  const handleExcel = () => exportToExcel(mockData, "task-assigns.xlsx");
  const handleExport = async () => {
    ...
    try {
          ...
          data={[
            {
              ...
              Timeline: "2025-06-26T12:00:00.000Z",
              Description: "Bangladesh",
              isDeleted: false,
            },
          ]}
          title="Task Assign Details"
          subtitle="Task Assign Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "task-assigns-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
