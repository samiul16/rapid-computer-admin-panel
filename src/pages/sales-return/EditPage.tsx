    ...
    <>
      ...
      >
        <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
          {/* First Row: Document Number, Sales Invoice Number, P.O Number, P.O Date, Customer, VAT Number */}
          <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
            ...
            <div className="space-y-2">
              <h3 className="font-medium mb-1">Sales Invoice Number</h3>
              <EditableInput
                ...
                onChange={handleChange}
                onNext={() => focusNextInput("salesInvoiceNumber")}
                onCancel={() => {}}
                tooltipText="Please enter sales invoice number"
                required
              />
            </div>
            <div className="space-y-2">
              ...
              <EditableInput
                ...
                onCancel={() => {}}
                tooltipText="Please enter P.O number"
              />
            </div>
            <div className="space-y-2">
              <h3 className="font-medium mb-1">
              ...
              <EditableInput
                ...
                onCancel={() => {}}
                tooltipText="Please select P.O date"
                required
              />
            </div>
            <div className="space-y-2">
      ...
      <LanguageTranslatorModal
        ...
        title="Sales Return Language Translator"
        initialData={translations}
        onSave={(data) => {
          setTranslations(data);
          console.log("Sales Return translations saved:", data);
        }}
      />
    </>
  );
