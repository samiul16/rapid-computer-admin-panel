...
export const salarySheetData: GridDataType[] = [
  {
    id: "1",
    from: "HR Department",
    salaryMonth: "January",
  ...
  },
  {
    ...
    draftedAt: new Date("2025-02-01T12:30:00Z"),
  ...
  },
  {
    ...
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-05-01T09:30:00Z"),
    draftedAt: null,
  ...
  },
  {
    ...
    isActive: false,
    isDraft: false,
    createdAt: new Date("2024-10-05T12:30:00Z"),
    draftedAt: null,
  ...
  },
  {
    ...
    draftedAt: new Date("2025-09-01T10:00:00Z"),
...
export default function ComponentLevelGridView({
  ...
  const [gridData, setGridData] = useState(salarySheetData);
