...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "blood-groups.csv");
  const handleExcel = () => exportToExcel(mockData, "blood-groups.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          title="Blood Groups Details"
          subtitle="Blood Groups Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "blood-groups-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
