...
export default function BloodGroupsEditPage({ isEdit = false }: Props) {
  ...
  const canView = usePermission("bloodGroups", "view");
  const canEdit = usePermission("bloodGroups", "edit");
  const canDelete = usePermission("bloodGroups", "delete");
  ...
  const code: boolean = usePermission("bloodGroups", "create", "code");

  const bloodGroup: boolean = usePermission(
    "bloodGroups",
    "create",
    "bloodGroup"
  );
  ...
  const isActive: boolean = usePermission("bloodGroups", "create", "isActive");
  ...
  const [popoverOptions, setPopoverOptions] = useState([
    {
      ...
      onClick: () => {
        if (isEdit) {
          navigate("/blood-groups/create");
        } else {
          navigate("/blood-groups/edit/undefined");
        }
      },
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (keepCreating) {
      toastSuccess("Blood Group created successfully!");
      handleReset();
    } else {
      toastSuccess("Blood Group created successfully!");
      navigate("/blood-groups");
    }
  };
        ...
        return [
          ...filteredOptions,
          {
            ...
            onClick: () => {
              ...
              toastRestore("Blood Group saved as draft successfully");
            },
  ...
  return (
    <>
      <PageLayout
        title={isEdit ? "Editing Blood Group" : "Creating Blood Group"}
        videoSrc={video}
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4 my-8 relative">
              ...
              {code && (
                <div className="space-y-2 md:col-span-4">
                  <EditableInput
                    ...
                    onNext={() => focusNextInput("bloodGroup")}
              ...
              {bloodGroup && (
                <div className="space-y-2 md:col-span-8">
                  <Autocomplete
                    ref={(el: any) => setRef("bloodGroup")(el)}
                    id="bloodGroup"
                    name="bloodGroup"
