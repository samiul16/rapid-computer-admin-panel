...
import DeliveryOrderLogisticGrid from "./DeliveryOrderLogisticGrid";
import DeliveryOrderLogisticDataTable from "./DeliveryOrderLogisticDataTable";
...
export default function DeliveryOrderLogisticPage() {
  ...
  return (
    <div className="w-100vw px-2 py-4 dark:bg-gray-900">
      ...
      <PageHeader
        ...
        title="Delivery Order Logistic"
        createPath="/delivery-order-logistic/create"
      />
      ...
      {viewMode === "grid" ? (
        ...
        <div className="mt-4 h-[calc(100vh-322px)] overflow-y-auto overflow-x-hidden border rounded-lg scroll-smooth [scrollbar-gutter:stable]">
          <DeliveryOrderLogisticDataTable
            viewMode={viewMode}
            searchQuery={searchQuery}
            setViewMode={setViewMode}
            dataTableFilter={dataTableFilter}
