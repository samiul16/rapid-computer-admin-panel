...
import LeadSourcesGrid from "./LeadSourcesGrid";
import TabsCounter from "@/components/common/TabsCounter";
import NewLeadSourcesDataTable from "./NewLeadSourcesDataTable";
  ...
  return (
    <div className="w-100vw px-2 py-4 dark:bg-gray-900">
      ...
      <PageHeader
        ...
        title="Lead Sources"
        createPath="/lead-sources/create"
      />
