...
export const plansData: GridDataType[] = [
  ...
  },
  {
    ...
    timeEfficiency: "88%",
    costPerHour: "28 USD",
    capacity: "450 units/day",
    oeeTarget: "82%",
    timeBeforeProduction: "20 mins",
    timeAfterProduction: "12 mins",
    description: "Medium appliance assembly line with robotic assistance.",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    description: "Primary packaging line for small appliances.",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    timeAfterProduction: "9 mins",
    description:
      "Handles medium appliance packaging with semi-automatic machines.",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  {
    id: "5",
    name: "Quality Control A",
    code: "QC-001",
    workingHours: "08:00 - 17:00",
    timeEfficiency: "95%",
    costPerHour: "30 USD",
    capacity: "1000 checks/day",
    oeeTarget: "90%",
    timeBeforeProduction: "5 mins",
    timeAfterProduction: "5 mins",
    description: "Performs final product quality checks for small appliances.",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  {
    id: "6",
    name: "Quality Control B",
    code: "QC-002",
    workingHours: "09:00 - 18:00",
    timeEfficiency: "93%",
    costPerHour: "32 USD",
    capacity: "900 checks/day",
    oeeTarget: "89%",
    timeBeforeProduction: "6 mins",
    timeAfterProduction: "6 mins",
    description:
      "Quality control for medium appliances with automated inspection.",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    oeeTarget: "80%",
    timeBeforeProduction: "8 mins",
    timeAfterProduction: "10 mins",
    description: "Storage and dispatch center for small appliances.",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    timeEfficiency: "83%",
    costPerHour: "19 USD",
    capacity: "1800 units/day",
    oeeTarget: "78%",
    timeBeforeProduction: "10 mins",
    timeAfterProduction: "12 mins",
    description: "Handles medium appliance storage and dispatch operations.",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    capacity: "N/A",
    oeeTarget: "100%",
    timeBeforeProduction: "N/A",
    timeAfterProduction: "N/A",
    description: "Handles preventive and corrective maintenance for all lines.",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    timeBeforeProduction: "N/A",
    timeAfterProduction: "N/A",
    description: "Handles machinery maintenance and emergency repairs.",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    timeEfficiency: "90%",
    costPerHour: "40 USD",
    capacity: "50 prototypes/day",
    oeeTarget: "87%",
    timeBeforeProduction: "15 mins",
    timeAfterProduction: "15 mins",
    description: "Research and development of new products and features.",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    timeAfterProduction: "10 mins",
    description:
      "Conducts electrical, mechanical, and safety tests on products.",
    isDefault: true,
    isActive: true,
    isDraft: false,
