...
export default function BookingSourceCreatePage({ isEdit = false }: Props) {
  ...
  const name: boolean = usePermission("bookingSource", "create", "name");
  ...
  const permissionsFields = usePermission<keyof MockData>(
    "bookingSource",
    "create",
    ["bookingType", "bookingSource", "commissionRate"]
  );
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (keepCreating) {
      toastSuccess("Booking Source created successfully!");
      handleReset();
    } else {
      toastSuccess("Booking Source created successfully!");
    ...
    try {
      ...
      const blob = await pdf(
        <GenericPDF
          data={[formData]}
          title="Booking Source Details"
          subtitle="Booking Source Information"
        />
      ).toBlob();
        ...
        return [
          ...filteredOptions,
          {
            ...
            onClick: () => {
              ...
              toastRestore("Booking Source saved as draft successfully");
            },
