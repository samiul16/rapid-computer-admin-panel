...
const autocompleteDataDetailsPage = ["Garage 1", "Garage 2", "Garage 3"];
...
export default function GaragesDetails() {
  ...
  const getLeavesData = (leaveType: string): DetailsPageTypes => {
    const leavesMap: Record<string, DetailsPageTypes> = {
      "Garage 1": initialData,
      "Garage 2": initialData,
      "Garage 3": initialData,
    };
