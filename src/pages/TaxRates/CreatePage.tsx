...
export default function TaxRatesCreatePage({ isEdit = false }: Props) {
  ...
  const name: boolean = usePermission("taxRates", "create", "name");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (keepCreating) {
      toastSuccess("Tax Rates created successfully!");
      handleReset();
    } else {
      toastSuccess("Tax Rates created successfully!");
      navigate("/tax-rates");
        ...
        return [
          ...filteredOptions,
          {
            ...
            onClick: () => {
              ...
              toastRestore("Tax Rates saved as draft successfully");
            },
