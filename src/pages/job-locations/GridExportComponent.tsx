...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "job-locations.csv");
  const handleExcel = () => exportToExcel(mockData, "job-locations.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          title="Job Locations Details"
          subtitle="Job Locations Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "job-locations-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
