...
import JobLocationsGrid from "./JobLocationsGrid";
import JobLocationsDataTable from "./JobLocationsDataTable";
  ...
  return (
    <div className="w-100vw px-2 py-4 dark:bg-gray-900">
      ...
      <PageHeader
        ...
        title="Job Locations"
        createPath="/job-locations/create"
      />
