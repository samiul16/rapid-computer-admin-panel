...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "waiters.csv");
  const handleExcel = () => exportToExcel(mockData, "waiters.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          title="Waiters Details"
          subtitle="Waiters Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "waiters-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
