...
export default function EmployeeContractEditPage({ isEdit = false }: Props) {
  ...
  const status: boolean = usePermission("employeeContract", "edit", "status");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (keepCreating) {
      handleReset();
      focusNextInput("staffName");
    } else {
      navigate("/employee-contract");
    }
    toastSuccess("Employee contract edited successfully");
  };
