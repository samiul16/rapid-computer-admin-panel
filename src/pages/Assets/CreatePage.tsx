...
export default function AssetsFormPage({ isEdit = false }: Props) {
  ...
  const assetName: boolean = usePermission("assetsCategory", "create", "assetName");
  const description: boolean = usePermission("assetsCategory", "create", "description");
  const isDefault: boolean = usePermission("assetsCategory", "create", "isDefault");
  const isDraft: boolean = usePermission("assetsCategory", "create", "isDraft");
  ...
  const [popoverOptions, setPopoverOptions] = useState([
    {
      ...
      onClick: () => {
        if (isEdit) {
          ...
          navigate("/assets/edit/undefined");
        }
      },
  ...
  const handlePrintAssets = (countryData: any) => {
    try {
  ...
  return (
    <>
      <PageLayout
        title={isEdit ? labels.creatingAsset : labels.creatingAsset}
        videoSrc={video}
