...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "Tax Rates.csv");
  const handleExcel = () => exportToExcel(mockData, "Tax Rates.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          subtitle="Tax Rates Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "Tax-Rates-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
