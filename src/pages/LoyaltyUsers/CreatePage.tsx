...
export default function AssetMaintenancesCreatePage({ isEdit = false }: Props) {
  ...
  const canCreate: boolean = usePermission("assetMaintenances", "create");
  const canView: boolean = usePermission("assetMaintenances", "view");
  ...
  const name: boolean = usePermission("assetMaintenances", "create", "name");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (keepCreating) {
      toastSuccess("Asset Maintenances created successfully!");
      handleReset();
    } else {
      toastSuccess("Asset Maintenances created successfully!");
  ...
  const handlePrintBookingList = (MockData: any) => {
    try {
      const html = PrintCommonLayout({
        title: "Asset Maintenances Details",
        data: [MockData],
    ...
    try {
      ...
      const blob = await pdf(
        <GenericPDF
          data={[formData]}
          title="Asset Maintenances Details"
          subtitle="Asset Maintenances Information"
        />
      ).toBlob();
        ...
        return [
          ...filteredOptions,
          {
            ...
            onClick: () => {
              ...
              toastRestore("Asset Maintenances saved as draft successfully");
            },
  ...
  return (
    <>
      <PageLayout
        title={
          isEdit
            ? labels.editingAssetMaintenances
            : labels.creatingAssetMaintenances
        }
        videoSrc={video}
