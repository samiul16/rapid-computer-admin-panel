...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "suppliers.csv");
  const handleExcel = () => exportToExcel(mockData, "suppliers.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          subtitle="Suppliers Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "suppliers-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
