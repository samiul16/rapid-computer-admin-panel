...
const autocompleteDataDetailsPage = ["Welcome Message", "Follow-up Reminder"];
...
export default function PredefinedRepliesDetails() {
            ...
            {fieldPermissions.replyName && (
              <div className="mt-1">
                <Autocomplete
                  ...
                  placeholder=" "
                  displayKey="replyName"
                  valueKey="replyName"
                  searchKey="replyName"
                  disabled={false}
                  className="w-[96%] bg-gray-100 rounded-xl"
                  labelClassName="bg-gray-50 rounded-2xl"
                  labelText="Reply Name"
