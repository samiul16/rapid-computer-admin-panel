...
export const plansData: GridDataType[] = [
  ...
  },
  {
    ...
    body: "Just following up regarding our last discussion.",
    isDefault: false,
    isActive: false,
    isDraft: true,
    createdAt: new Date("2025-07-10T12:00:00Z"),
    draftedAt: new Date("2025-07-11T14:00:00Z"),
  ...
  },
  {
    ...
    body: "Your meeting has been confirmed for tomorrow.",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    body: "Your account has been deleted permanently.",
    isDefault: false,
    isActive: false,
    isDraft: false,
    createdAt: new Date("2025-06-05T11:00:00Z"),
    draftedAt: null,
    updatedAt: new Date("2025-06-08T12:00:00Z"),
    deletedAt: new Date("2025-06-09T13:00:00Z"),
    isDeleted: true,
  },
  {
    id: "5",
    replyName: "Payment Received",
    body: "We’ve received your payment successfully.",
    isDefault: false,
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-08-01T10:00:00Z"),
    draftedAt: null,
    updatedAt: new Date("2025-08-03T15:00:00Z"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    ...
    body: "A support ticket has been opened for your issue.",
    isDefault: true,
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-06-20T09:00:00Z"),
    draftedAt: null,
    updatedAt: new Date("2025-07-01T11:30:00Z"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    ...
    draftedAt: new Date("2025-07-06T09:00:00Z"),
  ...
  {
    id: "8",
    replyName: "Profile Updated",
    body: "Your profile details were successfully updated.",
    isDefault: false,
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-07-25T13:00:00Z"),
    draftedAt: null,
  ...
  },
  {
    ...
    body: "You’ve been assigned to a new project.",
    isDefault: false,
    isActive: true,
    isDraft: false,
    createdAt: new Date("2025-07-08T09:30:00Z"),
    draftedAt: null,
    updatedAt: new Date("2025-07-15T10:30:00Z"),
    deletedAt: null,
    isDeleted: false,
  },
  {
    ...
    body: "Your assigned task has been completed.",
    isDefault: false,
    isActive: false,
    isDraft: false,
    createdAt: new Date("2025-06-18T07:00:00Z"),
    draftedAt: null,
    updatedAt: new Date("2025-06-20T08:30:00Z"),
    deletedAt: new Date("2025-06-22T09:00:00Z"),
    isDeleted: true,
  },
  {
    id: "11",
