...
const mockData = [
  {
    branch: "Branch 1",
    customer: "Employee 1",
    customerNo: "2025-06-26T12:00:00.000Z",
    vendorCode: "2025-06-26T12:00:00.000Z",
    status: "Bangladesh",
    projectName: "Bangladesh",
    projectCode: "Bangladesh",
    projectType: "Bangladesh",
    startDate: "2025-06-26T12:00:00.000Z",
...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "projects.csv");
  const handleExcel = () => exportToExcel(mockData, "projects.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          subtitle="Project Information Report"
        />
      ).toBlob();
