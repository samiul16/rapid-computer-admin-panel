...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "training-programs.csv");
  const handleExcel = () => exportToExcel(mockData, "training-programs.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          data={[
            {
              ...
              applyPosition: "Frontend Developer",
              description:
                "Introduction to React.js for building modern web apps.",
              attachment: "react-fundamentals.pdf",
          ...
          subtitle="Training Programs Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "training-programs-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
