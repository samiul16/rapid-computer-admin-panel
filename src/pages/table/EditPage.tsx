...
// Table form doesn't need mock dropdown data
...
export default function EditPage({ isEdit = false }: Props) {
  ...
  // Table form doesn't need filtered dropdown options

  // Update translation data when table name changes
  useEffect(() => {
    setTranslations([
  ...
  // Table form doesn't need country/state filtering logic
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
              ...
              <Autocomplete
                ...
                placeholder="Select a table code..."
                disabled={false}
                className="w-full"
                styles={{
                  input: {
