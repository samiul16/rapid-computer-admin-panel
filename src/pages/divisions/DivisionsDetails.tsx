...
import { mockDivisionsHistoryData } from "@/mockData/divisions-history-mockdata";
...
export default function DivisionsDetails() {
  const { t } = useTranslation();
  const navigate = useNavigate();

  const [keepChanges, setKeepChanges] = useState(false);
  const [isOptionModalOpen, setIsOptionModalOpen] = useState(false);
  const [initialSelectedValue, setInitialSelectedValue] = useState("DHK");
    ...
    try {
      ...
      const blob = await pdf(
        <PDF
          ...
          subtitle="Division Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "division-details.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
  ...
  return (
    <>
      <PageLayout
        title={t("button.viewingDivision")}
        videoSrc={video}
        videoHeader="Rapid ERP Video"
        onListClick={() => navigate("/divisions")}
        listText="List"
        listPath="/divisions"
        popoverOptions={[
          {
            label: "Create",
            onClick: () => navigate("/divisions/create"),
          },
          {
            label: "Edit",
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
          ...
          <div className="md:col-span-3">
            <h3 className="font-medium mb-1">Division Name</h3>
      ...
      >
        ...
        <Modal.Body>
          <HistoryDataTable columnData={mockDivisionsHistoryData} />
        </Modal.Body>
      </Modal>
    </>
  );
