...
export const gridCardData: GridCardDataType[] = [
  ...
  },
  {
    ...
    code: "CTG",
    region: "South-East",
    description: "Includes port city and hilly districts",
    status: "active",
    isDeleted: false,
  },
  {
    ...
    code: "RAJ",
    region: "North-West",
    description: "Famous for mangoes and education",
    status: "inactive",
    isDeleted: false,
  },
  {
    ...
    code: "KHL",
    region: "South-West",
    description: "Home of Sundarbans and industries",
    status: "active",
    isDeleted: false,
  },
  {
    ...
    description: "River-based division with rich agriculture",
    status: "draft",
    isDeleted: false,
  },
  {
    ...
    code: "SYL",
    region: "North-East",
    description: "Tea gardens and remittance-rich zone",
    status: "active",
    isDeleted: false,
  },
  {
    ...
    code: "RNG",
    region: "North",
    description: "Cold region, agriculture-heavy",
    status: "active",
    isDeleted: false,
  },
  {
    ...
    description: "Newest division split from Dhaka",
    status: "inactive",
    isDeleted: false,
  },
];
...
export default function ComponentLevelGridTable({
  ...
  const loadMoreData = useCallback(async () => {
    ...
    const newItems = Array.from({ length: ITEMS_PER_PAGE }, (_, index) => ({
      ...
      name: `Division Name#${gridData.length + index + 1}`,
      region: `Region${gridData.length + index + 1}`,
  ...
  return (
    <div className="px-4 py-3 h-full flex flex-col bg-white dark:bg-gray-900 parent">
                  ...
                  <div className="flex items-center justify-center gap-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        ...
                        onClick={() => {
                          ...
                          toastSuccess(
                            item.status === "active"
                              ...
                              : "Division inactivated successfully"
                          );
                        }}
                      >
                        {item.status === "active" ? (
                    ...
                    <Tooltip label="Edit" position="top" withArrow>
                      <div
                        ...
                        onClick={() => navigate(`/divisions/edit/1`)}
                      >
          ...
          {isLoading && (
            <div className="flex justify-center items-center py-8">
              <div className="flex items-center gap-2 text-blue-600">
                ...
                <span className="text-sm">Loading more divisions...</span>
              </div>
            </div>
          )}
      ...
      <Modal
        ...
        title={
          <div className="">
            <h3 className="text-lg font-semibold pl-4">Import Divisions</h3>
          </div>
        }
        size="xl"
        overlayProps={{
