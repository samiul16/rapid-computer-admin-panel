...
export default function DivisionsCreatePage({ isEdit = false }: Props) {
  ...
  return (
    <>
      <PageLayout
        title={isEdit ? t("form.editingDivision") : t("form.creatingDivision")}
        videoSrc={video}
        ...
        popoverOptions={[
          {
            ...
            onClick: () => {
              ...
              if (isEdit) {
                ...
                navigate("/divisions/edit/undefined");
              }
            },
          },
          {
      ...
      >
        <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
            ...
            <div className="md:col-span-3 space-y-2">
              <h3 className="font-medium mb-1">{t("form.divisionName")}</h3>
              <EditableInput
                type="text"
                id="name"
                name="name"
                ...
                value={formData.name ?? ""}
                onChange={handleChange}
                onNext={() => focusNextInput("region")}
                setRef={setRef("name")}
                tooltipText="Please enter division name"
                required
              />
            </div>
            <div className="md:col-span-3 space-y-2">
              <h3 className="font-medium mb-1">{t("form.region")}</h3>
              <EditableInput
                type="text"
                id="region"
                name="region"
                ...
                setRef={setRef("region")}
                tooltipText="Please enter region"
                required
              />
            </div>
