...
const mockData = [
  {
    ...
    isDraft: false,
    isUpdated: false,
    actionMessage: "Delivery man created",
...
export default function GridExportComponent({
  data,
  setFilteredData,
  setIsExportOpen,
}: SimpleFilterProps) {
  ...
  const handleCSV = () => exportToCSV(mockData, "deliverymen.csv");
  const handleExcel = () => exportToExcel(mockData, "deliverymen.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          data={[
            {
              ...
              isDraft: false,
              isUpdated: false,
              actionMessage: "Deliveryman created",
          ...
          title="Delivery men Details"
          subtitle="Delivery men Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "deliverymen-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
