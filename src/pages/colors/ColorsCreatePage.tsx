...
export default function ColorsCreatePage({ isEdit = false }: Props) {
  ...
  return (
    <>
      <PageLayout
        title={isEdit ? t("form.editingColor") : t("form.creatingColor")}
        videoSrc={video}
      ...
      >
        <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
            ...
            <div className="md:col-span-3 space-y-2">
              <h3 className="font-medium mb-1">{t("form.hexCode")}</h3>
              <EditableInput
                type="color"
                id="hexCode"
                name="hexCode"
                ...
                tooltipText="Please enter hex code"
                required
              />
            </div>
