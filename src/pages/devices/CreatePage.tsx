...
export default function DevicesFormPage({ isEdit = false }: Props) {
  const navigate = useNavigate();
  const { isRTL } = useSelector((state: RootState) => state.language);

  const [keepCreating, setKeepCreating] = useState(false);
  // Modal state - keeping for future use
  ...
  const deviceCode: boolean = usePermission("devices", "create", "deviceCode");
  const name: boolean = usePermission("devices", "create", "name");
  const serialNo: boolean = usePermission("devices", "create", "serialNo");
  const customer: boolean = usePermission("devices", "create", "customer");
  const model: boolean = usePermission("devices", "create", "model");
  ...
  const image: boolean = usePermission("devices", "create", "image");
  const isDraft: boolean = usePermission("devices", "create", "isDraft");
  ...
  console.log("warrantyStartingDate", warrantyStartingDate);
  console.log("warrantyPeriodMonths", warrantyPeriodMonths);
  console.log("warrantyExpiryDate", warrantyExpiryDate);
  console.log("warrantyExpiringAlert", warrantyExpiringAlert);
