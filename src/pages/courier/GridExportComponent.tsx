...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "courier.csv");
  const handleExcel = () => exportToExcel(mockData, "courier.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          subtitle="Courier Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "courier-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
