...
export const formFields: FieldConfig[] = [
  ...
  },
  {
    ...
    placeholder: " ",
    nextFocus: "position",
    tooltip: "Select or enter category",
    required: true,
  },
  {
    name: "supplier",
    label: "Supplier",
    component: "autocomplete",
    options: ["Tech Supplies Ltd", "ABC Electronics", "XYZ Supplies"],
  ...
  },
  {
    ...
    label: "Manufacturer",
    component: "autocomplete",
    options: ["Logitech", "Microsoft", "Apple", "Samsung", "Google"],
    nextFocus: "location",
...
export default function AccessoriesEditPage({ isEdit = false }: Props) {
