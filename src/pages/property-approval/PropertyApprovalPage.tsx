...
import PropertyApprovalGrid from "./PropertyApprovalGrid";
import PropertyApprovalDataTable from "./PropertyApprovalDataTable";
  ...
  return (
    <div className="w-100vw px-2 py-4 dark:bg-gray-900">
      ...
      <PageHeader
        ...
        createPath="/property-approval/create"
      />
