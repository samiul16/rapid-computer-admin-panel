...
export default function PropertyApprovalDetails() {
  ...
  // get permission
  const canCreate: boolean = usePermission("propertyApproval", "create");
  const canView: boolean = usePermission("propertyApproval", "view");
  const canEdit: boolean = usePermission("propertyApproval", "edit");
  const canDelete: boolean = usePermission("propertyApproval", "delete");
  const canExport: boolean = usePermission("propertyApproval", "export");
  const canPdf: boolean = usePermission("propertyApproval", "pdf");
  const canPrint: boolean = usePermission("propertyApproval", "print");
  const canSeeHistory: boolean = usePermission("propertyApproval", "history");
  ...
  const group: boolean = usePermission("propertyApproval", "view", "group");
  ...
  const zone: boolean = usePermission("propertyApproval", "view", "zone");
  const city: boolean = usePermission("propertyApproval", "view", "city");
  const state: boolean = usePermission("propertyApproval", "view", "state");
  const zipCode: boolean = usePermission("propertyApproval", "view", "zipCode");
  const areaNumber: boolean = usePermission(
    "propertyApproval",
    "view",
    "areaNumber"
  );
  const country: boolean = usePermission("propertyApproval", "view", "country");
  ...
  const handlePrintLeaves = (leavesData: any) => {
    try {
      const html = PrintCommonLayout({
        ...
        fieldLabels: {
          propertyCode: "Property Approval Code",
          propertyName: "Property Approval Name",
          group: "Group",
          propertyType: "Property Approval Type",
          propertyStyle: "Property Approval Style",
  ...
  return (
    <>
      <PageLayout
        title="Viewing Property Approval"
        videoSrc={video}
        videoHeader="Tutorial video"
        onListClick={() => navigate("/property-approval")}
        listText="List"
        ...
        popoverOptions={[
          {
            ...
            onClick: () => navigate("/property-approval/create"),
          },
          {
            label: "Edit",
            icon: <Edit className="w-5 h-5 text-blue-600" />,
            onClick: () => navigate("/property-approval/edit/1"),
          },
        ]}
