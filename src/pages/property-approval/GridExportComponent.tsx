...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "property-approval.csv");
  const handleExcel = () => exportToExcel(mockData, "property-approval.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          subtitle="Property Approval Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "property-approval-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
