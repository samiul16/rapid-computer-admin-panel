...
export default function PropertyApprovalGrid({
  ...
  const canRestore: boolean = usePermission("propertyApproval", "restore");
  const canEdit: boolean = usePermission("propertyApproval", "edit");

  // Debug permissions
  console.log("Property Approval Permissions:", {
    canDelete,
    canRestore,
    canEdit,
  });
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Total {gridData.length} Properties Approval
        </span>
      </div>
              ...
              >
                ...
                <div className="grid grid-cols-2 items-center gap-2 mb-4">
                  ...
                  <CardTitle
                    ...
                    onClick={() => navigate(`/property-approval/1`)}
                  >
                    {item.propertyName}
                  </CardTitle>
                      ...
                      <button
                        ...
                        onClick={() => {
                          if (canRestore && item.isDeleted) {
                            ...
                            toastRestore(
                              "Property approval restored successfully"
                            );
                          } else {
                            if (canDelete) {
                              handleDeleteClick(item.id);
                              toastDelete(
                                "Property approval deleted successfully"
                              );
                            }
                          }
                        }}
            ...
            <div className="flex justify-center items-center py-8">
              <div className="flex items-center gap-2 text-blue-600">
                ...
                <span className="text-sm">
                  Loading more property approval...
                </span>
              </div>
            </div>
          )}
          ...
          {!hasMore && gridData.length > 12 && (
            <div className="flex justify-center items-center py-8">
              <span className="text-sm text-gray-500 dark:text-gray-400">
                No more property approval to load
              </span>
            </div>
          )}
        </div>
