...
export default function ProjectTypeEditPage({ isEdit = false }: Props) {
  ...
  const canView = usePermission("projectTypes", "view");
  const canEdit = usePermission("projectTypes", "edit");
  const canDelete = usePermission("projectTypes", "delete");
  ...
  const code: boolean = usePermission("projectTypes", "create", "code");
  ...
  const isDraft: boolean = usePermission("projectTypes", "create", "isDraft");
  ...
  const [popoverOptions, setPopoverOptions] = useState([
    {
      ...
      onClick: () => {
        if (isEdit) {
          ...
          navigate("/project-types/edit/undefined");
        }
      },
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (keepCreating) {
      toastSuccess("Project Type created successfully!");
      handleReset();
    } else {
      toastSuccess("Project Type created successfully!");
  ...
  return (
    <>
      <PageLayout
        title={isEdit ? "Editing Project Type" : "Creating Project Type"}
        videoSrc={video}
      ...
      >
        <div dir={isRTL ? "rtl" : "ltr"}>
          ...
          >
            ...
            <div className="grid grid-cols-12 gap-4 my-8 relative">
              ...
              {projectType && (
                <div className="space-y-2 col-span-4">
                  <EditableInput
                    ...
                    tooltipText="Enter project type"
                    required
                  />
                </div>
              )}
