...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "employee-performances.csv");
  const handleExcel = () =>
    exportToExcel(mockData, "employee-performances.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          title="Employee Performances Details"
          subtitle="Employee Performances Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "employee-performances-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
