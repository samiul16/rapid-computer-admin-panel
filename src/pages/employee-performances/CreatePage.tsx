...
export default function EmployeePerformancesCreatePage({
  isEdit = false,
}: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (keepCreating) {
      toastSuccess("Employee Performance created successfully!");
      handleReset();
    } else {
      toastSuccess("Employee Performance created successfully!");
              ...
              {permissionsFieldLevel.demonstratedKnowledgeOfDutiesQualityOfWork && (
                <div className="space-y-2">
                  <Autocomplete
                    ...
                    isSelectableOnly={true}
                    onValueChange={(value: string) => {
                      const selectedValue = ratingData.find(
              ...
              {permissionsFieldLevel.demonstratedKnowledgeOfDutiesQualityOfWorkComments && (
                <div className="space-y-2">
                  <EditableInput
                    ...
                    onChange={handleChange}
                    onNext={() => focusNextInput("timelinessOfDelivery")}
                    onCancel={() =>
                      setFormData({
                        ...formData,
                        demonstratedKnowledgeOfDutiesQualityOfWorkComments: "",
                    ...
                    onValueChange={(value: string) => {
                      ...
                      if (selectedValue) {
                        setFormData((prev) => ({
                          ...
                          timelinessOfDeliveryScore: selectedValue.value,
                        }));
                      }
                      // Call focusNextInput if needed
              ...
              {permissionsFieldLevel.timelinessOfDeliveryScore && (
                <div className="space-y-2">
                  <EditableInput
                    ...
                    onChange={handleChange}
                    onNext={() =>
                      focusNextInput("timelinessOfDeliveryComments")
                    }
                    onCancel={() =>
                      setFormData({
                        ...formData,
              ...
              {permissionsFieldLevel.timelinessOfDeliveryComments && (
                <div className="space-y-2">
                  <EditableInput
                    ...
                    onChange={handleChange}
                    onNext={() => focusNextInput("impactOfAchievement")}
                    onCancel={() =>
                      setFormData({
                        ...formData,
                        timelinessOfDeliveryComments: "",
                    ...
                    onValueChange={(value: string) => {
                      ...
                      if (selectedValue) {
                        setFormData((prev) => ({
                          ...
                          impactOfAchievementScore: selectedValue.value,
                        }));
                      }
                      // Call focusNextInput if needed
              ...
              {permissionsFieldLevel.impactOfAchievementScore && (
                <div className="space-y-2">
                  <EditableInput
                    ...
                    onChange={handleChange}
                    onNext={() => focusNextInput("impactOfAchievementComments")}
                    onCancel={() =>
                      setFormData({
                        ...formData,
                        impactOfAchievementScore: "",
              ...
              {permissionsFieldLevel.impactOfAchievementComments && (
                <div className="space-y-2">
                  <EditableInput
                    ...
                    onChange={handleChange}
                    onNext={() =>
                      focusNextInput("overallAchievementOfGoalsObjectives")
                    }
                    onCancel={() =>
                      setFormData({
                        ...formData,
              ...
              {permissionsFieldLevel.overallAchievementOfGoalsObjectivesComments && (
                <div className="space-y-2">
                  <EditableInput
                    ...
                    onChange={handleChange}
                    onNext={() => focusNextInput("goingBeyondTheCallOfDuty")}
                    onCancel={() =>
                      setFormData({
                        ...formData,
                        overallAchievementOfGoalsObjectivesComments: "",
                    ...
                    onValueChange={(value: string) => {
                      ...
                      if (selectedValue) {
                        setFormData((prev) => ({
                          ...
                          goingBeyondTheCallOfDutyScore: selectedValue.value,
                        }));
                      }
              ...
              {permissionsFieldLevel.goingBeyondTheCallOfDutyScore && (
                <div className="space-y-2">
                  <EditableInput
                    ...
                    onChange={handleChange}
                    onNext={() =>
                      focusNextInput("goingBeyondTheCallOfDutyComments")
                    }
                    onCancel={() =>
                      setFormData({
                        ...formData,
