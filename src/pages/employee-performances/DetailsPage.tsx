...
const projectTypeOptions = ["CR7 Ronaldo", "Messi", "Yamal"];
...
export default function EmployeePerformancesDetails() {
  const navigate = useNavigate();
  const { isRTL } = useSelector((state: RootState) => state.language);

  const [keepChanges, setKeepChanges] = useState(false);
  const [isOptionModalOpen, setIsOptionModalOpen] = useState(false);
  const [selectedLeaveType, setSelectedLeaveType] = useState("CR7 Ronaldo");
  ...
  // get permission
  // const canCreate: boolean = usePermission("employeePerformances", "create");
  // const canView: boolean = usePermission("employeePerformances", "view");
  ...
  // const canExport: boolean = usePermission("employeePerformances", "export");
    ...
    try {
      ...
      const blob = await pdf(
        <GenericPDF
          data={[leavesData]}
          title="Employee Performances Details"
          subtitle="Employee Performances Information"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "employee-performances-details.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
  ...
  return (
    <>
      <PageLayout
        title="Viewing Employee Performances"
        videoSrc={video}
        videoHeader="Tutorial video"
        onListClick={() => navigate("/employee-performances")}
        listText="List"
        ...
        popoverOptions={[
          {
            ...
            onClick: () => navigate("/employee-performances/create"),
          },
          {
            label: "Edit",
            icon: <Edit className="w-5 h-5 text-blue-600" />,
            onClick: () => navigate("/employee-performances/edit/1"),
          },
        ]}
      ...
      >
        <div dir={isRTL ? "rtl" : "ltr"}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
            ...
            {fieldPermissions.totalScore && (
              <div className="">
                <h3 className="font-normal mb-1 text-gray-600">Total Score</h3>
                <div className="w-full py-1 text-gray-900 font-bold text-md dark:text-white">
                  {displayValue(leavesData.totalScore)}
                </div>
              </div>
            )}
