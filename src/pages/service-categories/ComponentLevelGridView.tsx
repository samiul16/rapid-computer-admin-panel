...
export const plansData: GridDataType[] = [
  ...
  },
  {
    ...
    description: "Professional kitchen management and operations",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    description: "Large event and wedding catering services",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    id: "9",
    name: "Buffet Service",
    description: "Self-service buffet setup and management",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    id: "10",
    name: "Room Service",
    description: "In-room dining and hospitality services",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    id: "11",
    name: "Event Service",
    description: "Special event and party catering services",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    description: "Business meeting and corporate event catering",
    isDefault: true,
    isActive: true,
    isDraft: false,
          ...
          <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 pb-4 p-2">
            {filteredData.map((item, index) => (
              ...
              >
                ...
                {/* Bottom Row - Grid with 2 columns: Description | Actions */}
