...
export default function PropertyEditPage({ isEdit = false }: Props) {
  ...
  const canView = usePermission("property", "view");
  const canEdit = usePermission("property", "edit");
  const canDelete = usePermission("property", "delete");
  ...
  const group: boolean = usePermission("property", "create", "group");
  ...
  const yearBuilt: boolean = usePermission("property", "create", "yearBuilt");
  ...
  const lotSizeSqm: boolean = usePermission("property", "create", "lotSizeSqm");
  ...
  const building: boolean = usePermission("property", "create", "building");
  const streetNumber: boolean = usePermission(
    "property",
    "create",
    "streetNumber"
  );
  const streetName: boolean = usePermission("property", "create", "streetName");
  const streetType: boolean = usePermission("property", "create", "streetType");
  const zone: boolean = usePermission("property", "create", "zone");
  const city: boolean = usePermission("property", "create", "city");
  const state: boolean = usePermission("property", "create", "state");
  const zipCode: boolean = usePermission("property", "create", "zipCode");
  const areaNumber: boolean = usePermission("property", "create", "areaNumber");
  const country: boolean = usePermission("property", "create", "country");
  const latitude: boolean = usePermission("property", "create", "latitude");
  const longitude: boolean = usePermission("property", "create", "longitude");
  ...
  const isDefault: boolean = usePermission("property", "create", "isDefault");

  const isActive: boolean = usePermission("property", "create", "isActive");
  const isDeleted: boolean = usePermission("property", "create", "isDeleted");

  const isDraft: boolean = usePermission("property", "create", "isDraft");
  ...
  const [popoverOptions, setPopoverOptions] = useState([
    {
      ...
      onClick: () => {
        if (isEdit) {
          ...
          navigate("/property/edit/undefined");
        }
      },
        ...
        return [
          ...filteredOptions,
          {
            ...
            onClick: () => {
              ...
              toastRestore("Property saved as draft successfully");
            },
  ...
  return (
    <>
      <PageLayout
        title={isEdit ? "Editing Property" : "Creating Property"}
        videoSrc={video}
