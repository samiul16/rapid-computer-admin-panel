...
export default function SimpleFilterComponent({
  ...
  const handleCSV = () => exportToCSV(mockData, "properties.csv");
  const handleExcel = () => exportToExcel(mockData, "properties.xlsx");
    ...
    try {
      const blob = await pdf(
        <PDF
          ...
          subtitle="Properties Information Report"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "properties-summary.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
