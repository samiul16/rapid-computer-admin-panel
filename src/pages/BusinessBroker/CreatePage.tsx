...
export default function BusinessBrokerCreatePage({ isEdit = false }: Props) {
  ...
  // Permission checks
  const canCreate = usePermission("businessBroker", "create");
  ...
  return (
    <>
      <PageLayout
        title={isEdit ? labels.editingBusinessBroker : labels.creatingBusinessBroker}
        videoSrc={video}
