...
import BusinessBrokerDataTable from "./BusinessBrokerDataTable";
import BusinessBrokerGrid from "./BusinessBrokerGrid";
...
export default function BusinessBrokerPage() {
  ...
  return (
    <div className="w-100vw px-2 py-4 dark:bg-gray-900">
      ...
      <PageHeader
        ...
        createPath="/business-broker/create"
      />
