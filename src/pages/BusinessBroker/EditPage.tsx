...
const initialData: ProjectTypeDataType = {
  ...
  aboutInformation:
    "Rapid Smart Erp is one of the leading electronics retailers in Bangladesh providing high quality products.",
...
export default function BusinessBrokerEditPage({ isEdit = false }: Props) {
  ...
  const canView = usePermission("businessBroker", "view");
  const canEdit = usePermission("businessBroker", "edit");
  const canDelete = usePermission("businessBroker", "delete");
  ...
  // const branch: boolean = usePermission("businessBroker", "create", "branch");
  ...
  // const category: boolean = usePermission("businessBroker", "create", "category");
  ...
  // const expense: boolean = usePermission("businessBroker", "create", "expense");

  // const date: boolean = usePermission("businessBroker", "create", "date");
  // const amount: boolean = usePermission("businessBroker", "create", "amount");
  // const currency: boolean = usePermission("businessBroker", "create", "currency");
  // const paymentMode: boolean = usePermission(
  //   "businessBroker",
  //   "create",
  //   "paymentMode"
  // );
  // const vat: boolean = usePermission("businessBroker", "create", "vat");
  // const supplier: boolean = usePermission("businessBroker", "create", "supplier");
  // const approvedBy: boolean = usePermission("businessBroker", "create", "approvedBy");
  ...
  //   "supplierVatNumber"
  // );
  // const expenseBy: boolean = usePermission("businessBroker", "create", "expenseBy");
  // const expenseFor: boolean = usePermission("businessBroker", "create", "expenseFor");
  // const note: boolean = usePermission("businessBroker", "create", "note");
  ...
  const isDraft: boolean = usePermission("businessBroker", "create", "isDraft");
  ...
  const [popoverOptions, setPopoverOptions] = useState([
    {
      ...
      onClick: () => {
        if (isEdit) {
          navigate("/business-broker/create");
        } else {
          navigate("/business-broker/edit/undefined");
        }
      },
  ...
  return (
    <>
      <PageLayout
        title={
          isEdit ? labels.editingBusinessBroker : labels.creatingBusinessBroker
        }
        videoSrc={video}
