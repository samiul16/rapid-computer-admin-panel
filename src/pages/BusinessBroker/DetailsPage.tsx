...
const initialData: TermsData = {
  picture: "https://images.ctfassets.net/zuzzsqg9enty/5dw0Zli6kAH32Y0tx10LYe/6a2f5361455e3b7945646dfca1af2191/Willem-Brocker.webp",
  code: "CMP-001",
...
export default function BusinessBrokerDetails() {
  ...
  // get permission
  const canCreate: boolean = usePermission("businessBroker", "create");
  const canView: boolean = usePermission("businessBroker", "view");
  const canEdit: boolean = usePermission("businessBroker", "edit");
  const canDelete: boolean = usePermission("businessBroker", "delete");
  const canExport: boolean = usePermission("businessBroker", "export");
  const canPdf: boolean = usePermission("businessBroker", "pdf");
  const canPrint: boolean = usePermission("businessBroker", "print");
  const canSeeHistory: boolean = usePermission("businessBroker", "history");

  // // Field-level permissions
  // const branch: boolean = usePermission("businessBroker", "view", "branch");
  ...
  // const category: boolean = usePermission("businessBroker", "view", "category");

  // const subCategory: boolean = usePermission("businessBroker", "view", "subCategory");

  // const expense: boolean = usePermission("businessBroker", "view", "expense");

  // const date: boolean = usePermission("businessBroker", "view", "date");
  // const amount: boolean = usePermission("businessBroker", "view", "amount");
  // const currency: boolean = usePermission("businessBroker", "view", "currency");
  // const paymentMode: boolean = usePermission("businessBroker", "view", "paymentMode");
  // const vat: boolean = usePermission("businessBroker", "view", "vat");
  // const supplier: boolean = usePermission("businessBroker", "view", "supplier");
  // const approvedBy: boolean = usePermission("businessBroker", "view", "approvedBy");
  ...
  //   "supplierVatNumber"
  // );
  // const expenseBy: boolean = usePermission("businessBroker", "view", "expenseBy");
  // const expenseFor: boolean = usePermission("businessBroker", "view", "expenseFor");
  // const note: boolean = usePermission("businessBroker", "view", "note");
  ...
  return (
    <>
      <PageLayout
        title={t("button.viewingBusinessBroker")}
        videoSrc={video}
        videoHeader="Tutorial video"
        onListClick={() => navigate("/business-broker")}
        listText="List"
        listPath="business-broker"
        activePage="view"
        popoverOptions={[
          {
            label: "Create",
            icon: <Plus className="w-5 h-5 text-green-600" />,
            onClick: () => navigate("/business-broker/create"),
          },
          {
            label: "Edit",
            icon: <Edit className="w-5 h-5 text-blue-600" />,
            onClick: () => navigate("/business-broker/edit/1"),
          },
        ]}
      ...
      >
        <div dir={isRTL ? "rtl" : "ltr"}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
            ...
            {
              <div>
                <h3 className="font-normal mb-1 text-gray-600">Broker Image</h3>
            ...
            {initialData.name && (
              <div>
                <h3 className="font-normal mb-1 text-gray-600">Name</h3>
                <div className="py-1 font-bold">
