...
export default function AssetsMasterFormPage({ isEdit = false }: Props) {
  ...
  // Permission checks - similar to AssetsDetails.tsx
  ...
  const assetName: boolean = usePermission("assetsMaster", "create", "assetName");
  const description: boolean = usePermission("assetsMaster", "create", "description");
  const isDefault: boolean = usePermission("assetsMaster", "create", "isDefault");
  const isDraft: boolean = usePermission("assetsMaster", "create", "isDraft");
  ...
  const handleSwitchChange = (checked: boolean) => {
    ...
    //   setTimeout(() => handlePrintAssets(formData), 100);
    // }
  };
  ...
  const handleExportPDF = async () => {
    ...
    try {
      console.log("assetData on pdf click", formData);
        ...
        return [
          ...filteredOptions,
          {
            ...
            onClick: () => {
              ...
              toastRestore("Assets saved as draft successfully");
            },
  ...
  return (
    <>
      <PageLayout
        title={isEdit ? labels.creatingAssetMaster : labels.creatingAssetMaster}
        videoSrc={video}
      ...
      >
        <div dir={isRTL ? "rtl" : "ltr"}>
          ...
          >
            {/* First Row: Code, Calling Code, Assets */}
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4 my-8 relative">
              {/* Assets field - only show if user can create */}
              {assetName && (
