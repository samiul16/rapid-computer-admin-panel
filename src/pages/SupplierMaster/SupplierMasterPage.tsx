...
import SupplierMasterGrid from "./SupplierMasterGrid";
import SupplierMasterDataTable2 from "./SupplierMasterDataTable2";
  ...
  return (
    <div className="w-100vw px-2 py-4 dark:bg-gray-900">
      ...
      <PageHeader
        ...
        createPath="/supplier-master/create"
      />
