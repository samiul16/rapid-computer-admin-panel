...
export default function BookingTypeGrid({
  searchQuery,
  setIsFilterOpen,
  isFilterOpen,
  setIsExportOpen,
  ...
  const canRestore: boolean = usePermission("bookingType", "restore");
  ...
  const loadMoreData = useCallback(async () => {
    ...
    const newItems = Array.from({ length: ITEMS_PER_PAGE }, (_, index) => ({
      ...
      bookingType: `Booking Type ${Date.now()}-${index}`,
      status: "active",
      isDeleted: false,
    }));
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Total {filteredRoomSize.length} Booking Types
        </span>
      </div>
