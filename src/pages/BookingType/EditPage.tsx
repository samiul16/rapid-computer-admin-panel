...
export default function BookingTypeEditPage({ isEdit = false }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toastSuccess("RoomSize Edited successfully");
  };
              ...
              {canEdit && (
                <div className="md:col-span-3 space-y-2">
                  <EditableInput
                    ...
                    onCancel={() =>
                      setFormData({ ...formData, bookingType: "" })
                    }
