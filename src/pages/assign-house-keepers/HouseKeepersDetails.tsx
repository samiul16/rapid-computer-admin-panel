...
export default function HouseKeeperDetailsPage() {
  ...
  // get permission
  const canCreate: boolean = usePermission("assignHouseKeepers", "create");
  const canView: boolean = usePermission("assignHouseKeepers", "view");
  ...
  const canExport: boolean = usePermission("assignHouseKeepers", "export");
  const canPdf: boolean = usePermission("assignHouseKeepers", "pdf");
  const canPrint: boolean = usePermission("assignHouseKeepers", "pdf");
  const canSeeHistory: boolean = usePermission("assignHouseKeepers", "history");

  // Field-level permissions
  const canViewHouseKeeperName: boolean = usePermission(
    "assignHouseKeepers",
    "view",
    "houseKeeperName"
  );
  const canViewRoomSizeName: boolean = usePermission(
    "assignHouseKeepers",
    "view",
    "roomSizeName"
  );
  ...
  return (
    <>
      <PageLayout
        ...
        onListClick={() => navigate("/assign-house-keepers")}
        listText="List"
            ...
            ? [
                {
                  ...
                  onClick: () => navigate("/assign-house-keepers/create"),
                },
              ]
            : []),
          ...(canEdit
            ? [
                {
                  ...
                  onClick: () => navigate("/assign-house-keepers/edit/1"),
                },
              ]
            : []),
        ]}
            ...
            {canViewRoomSizeName && (
              <div className="">
                ...
                <div className="w-full py-1 text-gray-900 font-bold text-md dark:text-white">
                  {displayValue(houseKeeperData.roomSizeName)}
                </div>
              </div>
            )}
