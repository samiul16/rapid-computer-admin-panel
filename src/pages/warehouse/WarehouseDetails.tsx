...
import { mockWarehouseHistoryData } from "@/mockData/warehouse-history-mockdata";
...
export default function WarehouseDetails() {
  ...
  const [initialSelectedValue, setInitialSelectedValue] = useState("MAIN-ST");
    ...
    try {
      ...
      const blob = await pdf(
        <PDF
          ...
          subtitle="Warehouse Information Report"
        />
      ).toBlob();
  ...
  return (
    <>
      <PageLayout
        title={t("button.viewingWarehouse")}
        videoSrc={video}
        videoHeader="Rapid ERP Video"
        onListClick={() => navigate("/warehouse")}
        listText="List"
        listPath="/warehouse"
        popoverOptions={[
          {
          ...
          {
            label: "Edit",
            onClick: () => navigate("/warehouse/edit/1"),
          },
        ]}
      ...
      >
        ...
        <Modal.Body>
          <HistoryDataTable columnData={mockWarehouseHistoryData} />
        </Modal.Body>
      </Modal>
    </>
  );
