...
export default function WarehouseCreatePage({ isEdit = false }: Props) {
    ...
    try {
      ...
      const blob = await pdf(
        <GenericPDF
          ...
          subtitle="Warehouse Information"
        />
      ).toBlob();
      ...
      a.href = url;
      a.download = "warehouse-details.pdf";
      a.click();
      console.log("a", a);
      console.log("url", url);
  ...
  return (
    <>
      <PageLayout
        title={
          isEdit ? t("form.editingWarehouse") : t("form.creatingWarehouse")
        }
        videoSrc={video}
        ...
        popoverOptions={[
          {
            ...
            onClick: () => {
              ...
              if (isEdit) {
                ...
                navigate("/warehouse/edit/undefined");
              }
            },
          },
          {
      ...
      >
        <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
            ...
            <div className="md:col-span-4 space-y-2">
              <h3 className="font-medium mb-1">{t("form.warehouseName")}</h3>
              <EditableInput
                type="text"
                id="name"
                name="name"
            ...
            <div className="md:col-span-4 space-y-2">
              <h3 className="font-medium mb-1">{t("form.managerName")}</h3>
              <EditableInput
                type="text"
                id="manager"
                name="manager"
                ...
                tooltipText="Please enter manager"
                required
              />
            </div>
            <div className="md:col-span-6 space-y-2">
              <h3 className="font-medium mb-1">{t("form.location")}</h3>
              <EditableInput
                type="text"
                id="location"
                name="location"
