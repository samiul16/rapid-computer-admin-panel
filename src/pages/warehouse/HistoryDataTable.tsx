    ...
    const columns: ColumnDef<HistoryEntry>[] = [
      {
        accessorKey: "code",
        header: ({ column }) => (
          <ColumnFilterHeader column={column} title="Code" />
        ),
        cell: (info) => (
      ...
      },
      {
        accessorKey: "name",
        header: ({ column }) => (
          <ColumnFilterHeader column={column} title="Name" />
        ),
        cell: (info) => (
      ...
      },
      {
        ...
        header: ({ column }) => (
          <ColumnFilterHeader column={column} title="Location" />
        ),
        cell: (info) => (
          <div className="text-sm text-gray-900 font-medium">
      ...
      },
      {
        accessorKey: "manager",
        header: ({ column }) => (
          <ColumnFilterHeader column={column} title="Manager" />
        ),
        cell: (info) => (
          <div className="text-sm text-gray-900 font-medium">
            {info.getValue() as string}
        ...
        sortingFn: (row1: any, row2: any) => {
          return row1
            .getValue("manager")
            .localeCompare(row2.getValue("manager"));
        },
        size: 120,
        minSize: 100,
      },
