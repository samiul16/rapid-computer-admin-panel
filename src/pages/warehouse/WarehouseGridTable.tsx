...
export const gridCardData: GridCardDataType[] = [
  ...
  },
  {
    ...
    description: "Stores all kitchen-related goods",
    status: "active",
    isDeleted: false,
  },
  {
    ...
    description: "For dry and non-perishable inventory",
    status: "inactive",
    isDeleted: false,
  },
  {
    ...
    description: "Frozen items and perishables",
    status: "draft",
    isDeleted: false,
  },
  {
    ...
    manager: "Shuvo Malik",
    description: "Supports Banani branch supplies",
    status: "active",
    isDeleted: false,
  },
  {
  ...
  },
  {
    ...
    description: "All beverage and drinks inventory",
    status: "inactive",
    isDeleted: false,
  },
  {
    ...
    manager: "Kazi Anik",
    description: "For storing meat and poultry items",
    status: "active",
    isDeleted: false,
  },
];

export default function WarehouseGridTable({
  setViewMode,
}: {
  ...
  const loadMoreData = useCallback(async () => {
    ...
    const newItems = Array.from({ length: ITEMS_PER_PAGE }, (_, index) => ({
      ...
      name: `Warehouse Name#${gridData.length + index + 1}`,
      location: `Location${gridData.length + index + 1}`,
      manager: `Manager${gridData.length + index + 1}`,
  ...
  return (
    <div className="px-4 py-3 h-full flex flex-col bg-white dark:bg-gray-900 parent">
                  ...
                  <div className="flex items-center justify-center gap-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        ...
                        onClick={() => {
                          ...
                          toastSuccess(
                            item.status === "active"
                              ...
                              : "Warehouse inactivated successfully"
                          );
                        }}
                      >
                        {item.status === "active" ? (
                    ...
                    <Tooltip label="Edit" position="top" withArrow>
                      <div
                        ...
                        onClick={() => navigate(`/warehouses/edit/1`)}
                      >
          ...
          {isLoading && (
            <div className="flex justify-center items-center py-8">
              <div className="flex items-center gap-2 text-blue-600">
                ...
                <span className="text-sm">Loading more warehouses...</span>
              </div>
            </div>
          )}
      ...
      <Modal
        ...
        title={
          <div className="">
            <h3 className="text-lg font-semibold pl-4">Import Warehouses</h3>
          </div>
        }
        size="xl"
        overlayProps={{
