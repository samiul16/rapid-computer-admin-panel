...
import ConsigneeMasterGrid from "./ConsigneeMasterGrid";
import ConsigneeMasterDataTable from "./ConsigneeMasterDataTable";
  ...
  return (
    <div className="w-100vw px-2 py-4 dark:bg-gray-900">
      ...
      <PageHeader
        ...
        createPath="/consignee-master/create"
      />
