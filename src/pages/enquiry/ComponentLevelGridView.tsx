...
export const plansData: GridDataType[] = [
  ...
  },
  {
    ...
    phoneNo: "+1-555-0987",
    enquiry: "General medicine consultation",
    readStatus: "Read",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    phoneNo: "+1-555-0234",
    enquiry: "ENT specialist appointment",
    readStatus: "Unread",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  {
    id: "9",
    emailAddress: "mark.taylor@email.com",
    fullName: "Mark Taylor",
    phoneNo: "+1-555-0890",
    enquiry: "Mental health consultation",
    readStatus: "Unread",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  {
    id: "10",
    emailAddress: "maria.martinez@email.com",
    fullName: "Maria Martinez",
    phoneNo: "+1-555-0345",
    enquiry: "Women's health consultation",
    readStatus: "Read",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  {
    id: "11",
    emailAddress: "james.white@email.com",
    fullName: "James White",
    phoneNo: "+1-555-0678",
    enquiry: "Cardiology follow-up appointment",
    readStatus: "Read",
    isDefault: false,
    isActive: true,
    isDraft: false,
  ...
  },
  {
    ...
    phoneNo: "+1-555-0901",
    enquiry: "Orthopedic surgery consultation",
    readStatus: "Unread",
    isDefault: true,
    isActive: true,
    isDraft: false,
        ...
        >
          <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 pb-4 p-2">
            {filteredData.map((item, index) => (
              ...
              >
                {/* Top Row - Grid with 2 columns: Email | Full Name */}
                ...
                <div className="grid grid-cols-3 items-center gap-4 pt-2 dark:border-gray-700">
                  ...
                  <div>
                    ...
                    >
                      {item.readStatus === "Unread" ? "High" : "Normal"}
                    </div>
                  </div>
                </div>
              </Card>
