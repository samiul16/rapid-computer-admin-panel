...
export default function ShelfCreatePage({ isEdit = false }: Props) {
  ...
  return (
    <>
      <PageLayout
        title={isEdit ? t("form.editingShelf") : t("form.creatingShelf")}
        videoSrc={video}
        ...
        popoverOptions={[
          {
            ...
            onClick: () => {
              ...
              if (isEdit) {
                ...
                navigate("/shelf/create");
              } else {
                // Navigate to edit page
                navigate("/shelf/edit/undefined");
              }
            },
          },
          {
      ...
      >
        <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
            ...
            <div className="md:col-span-4 space-y-2">
              <h3 className="font-medium mb-1">{t("form.shelfName")}</h3>
              <EditableInput
                type="text"
                id="name"
                name="name"
                ...
                setRef={setRef("name")}
                tooltipText="Please enter shelf name"
                required
              />
            </div>
