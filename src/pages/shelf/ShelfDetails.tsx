...
import { mockShelfHistoryData } from "@/mockData/shelf-history-mockdata";
...
export default function ShelfDetails() {
  ...
  const [initialSelectedValue, setInitialSelectedValue] = useState("DIN-A");
    ...
    try {
      ...
      const blob = await pdf(
        <PDF
          data={[viewData]}
          title="Shelf Details"
          subtitle="Shelf Information Report"
        />
      ).toBlob();
  ...
  return (
    <>
      <PageLayout
        title={t("button.viewingShelf")}
        videoSrc={video}
        videoHeader="Rapid ERP Video"
        onListClick={() => navigate("/shelf")}
        listText="List"
        listPath="/shelf"
        popoverOptions={[
          {
            label: "Create",
            onClick: () => navigate("/shelf/create"),
          },
          {
            label: "Edit",
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
          ...
          <div className="md:col-span-4">
            <h3 className="font-medium mb-1">Shelf Name</h3>
      ...
      >
        ...
        <Modal.Body>
          <HistoryDataTable columnData={mockShelfHistoryData} />
        </Modal.Body>
      </Modal>
    </>
  );
