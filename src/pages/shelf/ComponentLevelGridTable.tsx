...
export const gridCardData: GridCardDataType[] = [
  {
    ...
    name: "Shelf A1",
    code: "SH-A1",
    description: "Main storage near entrance",
    status: "active",
    isDeleted: false,
  },
  {
    ...
    name: "Shelf A2",
    code: "SH-A2",
    description: "Reserved shelf beside A1",
    status: "active",
    isDeleted: false,
  },
  {
    ...
    name: "Shelf B1",
    code: "SH-B1",
    description: "Dry goods storage shelf",
    status: "inactive",
    isDeleted: false,
  },
  {
    ...
    name: "Shelf B2",
    code: "SH-B2",
    description: "Backup storage section",
    status: "draft",
    isDeleted: false,
  },
  {
    ...
    name: "Shelf C1",
    code: "SH-C1",
    description: "Cold storage compatible shelf",
    status: "active",
    isDeleted: false,
  },
  {
  ...
  },
  {
    ...
    name: "Shelf E1",
    code: "SH-E1",
    description: "Cleaning supply storage",
    status: "inactive",
    isDeleted: false,
  },
  {
    ...
    name: "Shelf F1",
    code: "SH-F1",
    description: "Shelf for takeaway packaging",
    status: "draft",
    isDeleted: false,
  },
];
...
export default function ComponentLevelGridTable({
  ...
  const loadMoreData = useCallback(async () => {
    ...
    const newItems = Array.from({ length: ITEMS_PER_PAGE }, (_, index) => ({
      ...
      name: `Shelf Name#${gridData.length + index + 1}`,
  ...
  return (
    <div className="px-4 py-3 h-full flex flex-col bg-white dark:bg-gray-900 parent">
                    ...
                    >
                      <div
                        ...
                        onClick={() => {
                          ...
                          toastSuccess(
                            item.status === "active"
                              ? "Shelf activated successfully"
                              : "Shelf inactivated successfully"
                          );
                        }}
                      >
                        {item.status === "active" ? (
          ...
          {isLoading && (
            <div className="flex justify-center items-center py-8">
              <div className="flex items-center gap-2 text-blue-600">
                ...
                <span className="text-sm">Loading more shelf...</span>
              </div>
            </div>
          )}
      ...
      <Modal
        ...
        title={
          <div className="">
            <h3 className="text-lg font-semibold pl-4">Import Shelf</h3>
          </div>
        }
        size="xl"
        overlayProps={{
